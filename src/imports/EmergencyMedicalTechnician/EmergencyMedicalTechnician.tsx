...
function Frame36() {
  return (
    <div className="content-stretch flex flex-col font-['Inter:Bold',sans-serif] font-bold items-start relative shrink-0 text-[50px]">
      ...
      <p className="h-[139px] leading-[70px] relative shrink-0 text-[#25a88d] w-[587px]">Emergency Medical Technician</p>
    </div>
  );
}
...
function Frame15() {
  return (
    <div id="imed-online" data-nav="imed-online" className="absolute bg-[#1f3471] h-[666px] left-0 overflow-clip top-[66px] w-[1440px]">
      <div className="-translate-x-1/2 -translate-y-1/2 absolute h-[665px] left-[calc(50%+279.5px)] top-[calc(50%+0.5px)] w-[997px]" data-name="image 1722">
      ...
      <div className="absolute bg-gradient-to-r from-[#1f3471] from-[12.981%] h-[665px] left-[488px] to-[rgba(31,52,113,0)] top-px w-[311px]" />
      <Frame27 />
    </div>
  );
}
...
function Heading2() {
  return (
    <div className="h-[48px] relative shrink-0 w-full" data-name="Heading 3">
      <p className="-translate-x-1/2 absolute font-['Inter:Bold',sans-serif] font-bold leading-[48px] left-1/2 not-italic text-[#1f3471] text-[40px] text-center top-[-1px] whitespace-nowrap">What is Emergency Medical Technician?</p>
    </div>
  );
}
...
function Frame31() {
  return (
    <div className="bg-[#824747] h-[423px] overflow-clip relative rounded-[15px] shrink-0 w-[657px]">
      <div className="-translate-x-1/2 absolute h-[1009px] left-[calc(50%+4.5px)] top-[-24px] w-[672px]" data-name="image 1709" />
      <div className="-translate-y-1/2 absolute h-[436px] left-0 top-[calc(50%+0.5px)] w-[654px]" data-name="image 1748">
        <img loading="lazy" decoding="async" alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgImage1748} />
      </div>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full">
      <div className="font-['Inter:Regular',sans-serif] font-normal leading-[0] not-italic relative shrink-0 text-[#4a5565] text-[20px] text-justify w-full whitespace-pre-wrap">
        <p className="leading-[32.5px] mb-0">An Emergency Medical Technician (EMT) is a trained healthcare professional who provides immediate medical care in emergency situations before a patient reaches the hospital. They are often the first to respond to accidents, sudden illnesses, or critical incidents, where they quickly assess the patient's condition and deliver essential care such as first aid, CPR, and basic life support.</p>
        <p className="leading-[32.5px] mb-0"></p>
        <p className="leading-[32.5px]">EMTs also ensure the safe and timely transportation of patients to medical facilities while continuously monitoring their condition. Acting as a vital link between the emergency scene and hospital treatment, their ability to respond quickly, stay composed under pressure.</p>
      </div>
    </div>
  );
}
...
function Frame70() {
  return (
    <div className="-translate-y-1/2 absolute content-stretch flex gap-[15px] items-center left-[15px] top-[calc(50%+0.5px)]">
      <Frame69 />
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[48px] not-italic relative shrink-0 text-[18px] text-black text-center whitespace-nowrap">Emergency response fundamentals</p>
    </div>
  );
}
...
function Frame71() {
  return (
    <div className="-translate-y-1/2 absolute content-stretch flex gap-[15px] items-center left-[15px] top-[calc(50%+0.5px)]">
      <Frame72 />
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[48px] not-italic relative shrink-0 text-[18px] text-black text-center whitespace-nowrap">Ambulance operations and patient transport</p>
    </div>
  );
}
...
function Frame73() {
  return (
    <div className="-translate-y-1/2 absolute content-stretch flex gap-[15px] items-center left-[15px] top-[calc(50%+0.5px)]">
      <Frame74 />
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[48px] not-italic relative shrink-0 text-[18px] text-black text-center whitespace-nowrap">Disaster management basics</p>
    </div>
  );
}
...
function Frame75() {
  return (
    <div className="-translate-y-1/2 absolute content-stretch flex gap-[15px] items-center left-[15px] top-[calc(50%+0.5px)]">
      <Frame76 />
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[48px] not-italic relative shrink-0 text-[18px] text-black text-center whitespace-nowrap">Infection control and safety practices</p>
    </div>
  );
}
...
function Frame77() {
  return (
    <div className="-translate-y-1/2 absolute content-stretch flex gap-[15px] items-center left-[15px] top-[calc(50%+0.5px)]">
      <Frame83 />
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[48px] not-italic relative shrink-0 text-[18px] text-black text-center whitespace-nowrap">Basic life support and CPR concepts</p>
    </div>
  );
}
...
function Frame85() {
  return (
    <div className="-translate-y-1/2 absolute content-stretch flex gap-[15px] items-center left-[15px] top-[calc(50%+0.5px)]">
      <Frame89 />
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[48px] not-italic relative shrink-0 text-[18px] text-black text-center whitespace-nowrap">Trauma and accident response support</p>
    </div>
  );
}
...
function Frame91() {
  return (
    <div className="-translate-y-1/2 absolute content-stretch flex gap-[15px] items-center left-[15px] top-[calc(50%+0.5px)]">
      <Frame92 />
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[48px] not-italic relative shrink-0 text-[18px] text-black text-center whitespace-nowrap">Emergency communication and documentation</p>
    </div>
  );
}
...
function Frame94() {
  return (
    <div className="-translate-y-1/2 absolute content-stretch flex gap-[15px] items-center left-[15px] top-[calc(50%+0.5px)]">
      <Frame95 />
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[48px] not-italic relative shrink-0 text-[18px] text-black text-center whitespace-nowrap">Practical simulation-based training</p>
    </div>
  );
}
...
function Frame114() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      ...
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[23px] not-italic relative shrink-0 text-[18px] text-center text-white whitespace-nowrap">10th or 12th pass from a recognized board</p>
    </div>
  );
}
...
function Frame117() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0 w-full">
      ...
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[23px] not-italic relative shrink-0 text-[18px] text-center text-white whitespace-nowrap">Interest in emergency response and public service</p>
    </div>
  );
}
...
function Frame118() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      ...
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[23px] not-italic relative shrink-0 text-[18px] text-center text-white whitespace-nowrap">Basic communication skills</p>
    </div>
  );
}
...
function Frame119() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      ...
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[23px] not-italic relative shrink-0 text-[18px] text-center text-white whitespace-nowrap">Physical fitness suitable for field training</p>
    </div>
  );
}
...
function Frame42() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[764px]">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[32.5px] not-italic relative shrink-0 text-[#4a5565] text-[20px] text-justify w-full">{`India's emergency care ecosystem is expanding through ambulance networks, emergency departments, corporate hospitals, event medical teams, and disaster-response services. Trained EMTs are needed in ambulance services, hospitals, emergency call centers, industrial safety teams, and public health programs. The growing focus on emergency healthcare is increasing demand for skilled EMTs, offering strong career opportunities and job stability.`}</p>
    </div>
  );
}
...
function Frame32() {
  return (
    <div className="bg-[#824747] h-[517px] overflow-clip relative rounded-[15px] shrink-0 w-[499px]">
      <div className="-translate-x-1/2 -translate-y-1/2 absolute h-[755px] left-[calc(50%+2px)] top-1/2 w-[503px]" data-name="image 1709">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img loading="lazy" decoding="async" alt="" className="absolute h-[75.1%] left-[-0.1%] max-w-none top-[12.54%] w-[112.72%]" src={imgImage1709} />
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="h-[24px] relative shrink-0 w-[246px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[24px] left-0 not-italic text-[16px] text-white top-[-2.2px] whitespace-nowrap">Salary by Role</p>
      </div>
    </div>
  );
}
...
function About4() {
  return <ScopeSalarySection defaultRole="Emergency Medical Technician" topClassName="top-[2954px]" />;
}
...
function Frame51() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      <MdiTick />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[27px] not-italic relative shrink-0 text-[#333] text-[18px] whitespace-nowrap">Simulation-based emergency response training</p>
    </div>
  );
}
...
function Frame54() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      <MdiTick1 />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[27px] not-italic relative shrink-0 text-[#333] text-[18px] whitespace-nowrap">Faculty guidance from Healthcare and Emergency care professionals</p>
    </div>
  );
}
...
function Frame55() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      <MdiTick2 />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[27px] not-italic relative shrink-0 text-[#333] text-[18px] whitespace-nowrap">Training on ambulance workflow, safety, and documentation</p>
    </div>
  );
}
...
function Frame56() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      <MdiTick3 />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[27px] not-italic relative shrink-0 text-[#333] text-[18px] whitespace-nowrap">Soft-skills support for communication in high-pressure situations</p>
    </div>
  );
}
...
function Frame57() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      <MdiTick4 />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[27px] not-italic relative shrink-0 text-[#333] text-[18px] w-[566px]">Practical exposure through partner Healthcare facilities</p>
    </div>
  );
}
...
function Frame58() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      <MdiTick5 />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[27px] not-italic relative shrink-0 text-[#333] text-[18px] w-[566px]">Career mentoring for ambulance, Hospital, and emergency service roles</p>
    </div>
  );
}
...
function Frame60() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      <MdiTick6 />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[27px] not-italic relative shrink-0 text-[#333] text-[18px] whitespace-nowrap">Placement assistance with ambulance providers and Hospitals</p>
    </div>
  );
}
...
function Frame61() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      <MdiTick7 />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[27px] not-italic relative shrink-0 text-[#333] text-[18px] whitespace-nowrap">Resume building for emergency care roles</p>
    </div>
  );
}
...
function Frame62() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      <MdiTick8 />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[27px] not-italic relative shrink-0 text-[#333] text-[18px] whitespace-nowrap">Mock interviews and practical skill assessments</p>
    </div>
  );
}
...
function Frame63() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      <MdiTick9 />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[27px] not-italic relative shrink-0 text-[#333] text-[18px] w-[541px]">Internship guidance in emergency departments and transport services</p>
    </div>
  );
}
...
function Frame64() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      <MdiTick10 />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[27px] not-italic relative shrink-0 text-[#333] text-[18px] w-[541px]">Hiring support through partner institutes and Healthcare employers</p>
    </div>
  );
}
...
function Frame65() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      <MdiTick11 />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[27px] not-italic relative shrink-0 text-[#333] text-[18px] w-[566px]">Career counseling for long-term growth in emergency care</p>
    </div>
  );
}
...
function Frame34() {
  return (
    <div className="bg-[#824747] h-[565px] overflow-clip relative rounded-[15px] shrink-0 w-[620px]">
      <div className="-translate-x-1/2 -translate-y-1/2 absolute left-1/2 size-[620px] top-[calc(50%+27.74px)]" data-name="image 1723">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img loading="lazy" decoding="async" alt="" className="absolute h-full left-[-10.52%] max-w-none top-[-6.92%] w-[133.33%]" src={imgImage1724} />
        </div>
      </div>
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[0] left-[calc(50%-222px)] not-italic text-[22px] text-black top-[604px] whitespace-nowrap">
        <span className="leading-[22px]">{`One Nation. `}</span>
...
function Text20() {
  return (
    <div className="absolute h-[20px] left-[-0.2px] top-[15.8px] w-[192.425px]" data-name="Text">
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#0a0a0a] text-[20px] top-[-0.2px] whitespace-nowrap">What is an EMT course?</p>
    </div>
  );
}
...
function Text21() {
  return (
    <div className="absolute h-[20px] left-[-0.2px] top-[15.8px] w-[192.425px]" data-name="Text">
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#0a0a0a] text-[20px] top-[-0.2px] whitespace-nowrap">Will I become a doctor or nurse after EMT?</p>
    </div>
  );
}
...
function Text22() {
  return (
    <div className="absolute h-[20px] left-[-0.2px] top-[15.8px] w-[192.425px]" data-name="Text">
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#0a0a0a] text-[20px] top-[-0.2px] whitespace-nowrap">What jobs can I get after EMT?</p>
    </div>
  );
}
...
function Icon8() {
  return (
    <div className="absolute left-[782px] size-[28px] top-[17.4px]" data-name="Icon">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 28 28">
        <g id="Icon">
          <path d={svgPaths.pbfc4380} id="Vector" stroke="var(--stroke-0, #25A88D)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
        </g>
      </svg>
    </div>
  );
...
function Text23() {
  return (
    <div className="absolute h-[20px] left-[-0.2px] top-[15.8px] w-[192.425px]" data-name="Text">
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#0a0a0a] text-[20px] top-[-0.2px] whitespace-nowrap">Is practical training included?</p>
    </div>
  );
}
...
function Text24() {
  return (
    <div className="absolute h-[20px] left-[-0.2px] top-[15.8px] w-[192.425px]" data-name="Text">
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#0a0a0a] text-[20px] top-[-0.2px] whitespace-nowrap">Is EMT suitable after 12th?</p>
    </div>
  );
}
...
function Text25() {
  return (
    <div className="absolute h-[20px] left-[-0.2px] top-[15.8px] w-[192.425px]" data-name="Text">
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#0a0a0a] text-[20px] top-[-0.2px] whitespace-nowrap">Can I pursue higher studies after completing EMT?</p>
    </div>
  );
}
...
function Text26() {
  return (
    <div className="absolute h-[20px] left-[-0.2px] top-[15.8px] w-[192.425px]" data-name="Text">
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#0a0a0a] text-[20px] top-[-0.2px] whitespace-nowrap">What is the admission process for the EMT course?</p>
    </div>
  );
}
...
const emtFaqQuestions = [
  "What is an EMT course?",
  "Will I become a doctor or nurse after EMT?",
  "What jobs can I get after EMT?",
  "Is practical training included?",
  "Is EMT suitable after 12th?",
  "Can I pursue higher studies after completing EMT?",
  "What is the admission process for the EMT course?",
];

const emtAnswerIntros = [
  "Great question.",
  "Yes, and this is important to know.",
  "Most students ask this early in their journey.",
  "Here is the short answer.",
];

const emtAnswerOutros = [
  "Our counselors can guide you based on your city and career goals.",
  "You can discuss your profile with our team for a personalized roadmap.",
  "The exact path depends on your background, performance, and openings.",
  "We help you with both learning and next-step planning.",
];

function buildEmtRandomAnswer(question: string) {
  const intro = emtAnswerIntros[Math.floor(Math.random() * emtAnswerIntros.length)];
  const outro = emtAnswerOutros[Math.floor(Math.random() * emtAnswerOutros.length)];
  return `${intro} For "${question}", EMT training focuses on emergency patient care, practical hospital exposure, and job-readiness skills. ${outro}`;
}

function Container33() {
  const [openIndex, setOpenIndex] = useState(-1);
  const [faqItems] = useState(() =>
    emtFaqQuestions.map((question) => ({
      question,
      answer: buildEmtRandomAnswer(question),
    })),
  );
...
function About7() {
  return (
    <div className="-translate-x-1/2 absolute bg-white content-stretch flex flex-col gap-[39px] items-center left-1/2 px-[32px] py-[60px] top-[6389px] w-[1440px]" data-name="About">
      <Container31 />
      <Container32 />
    </div>
  );
...
function Heading19() {
  return (
    <div className="content-stretch flex h-[36px] items-start relative shrink-0 w-[905px]" data-name="Heading 3">
      <p className="flex-[1_0_0] font-['Inter:Bold',sans-serif] font-bold leading-[36px] min-w-px not-italic relative text-[30px] text-center text-white">Ready to start your EMT journey?</p>
    </div>
  );
}
      ...
      <div className="h-[37.242px] overflow-clip relative shrink-0 w-[125.692px]" data-name="Badge">
        ...
        <div className="absolute inset-[18.68%_83.04%_18.65%_7.38%]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12.0425 23.3415">
            <path d={svgPaths.p2192fa80} fill="url(#paint0_linear_1_1202)" id="Vector" />
            <defs>
              <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_1_1202" x1="11.0184" x2="-4.60472" y1="1.15451" y2="16.7776">
        ...
        <div className="absolute inset-[39.3%_75.52%_39.3%_16.96%]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 9.4502 7.96983">
            <path d={svgPaths.p14fc2800} fill="url(#paint0_linear_1_1104)" id="Vector" />
            <defs>
              <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_1_1104" x1="10.1764" x2="-12.3458" y1="3.98491" y2="3.98491">
        ...
        <div className="absolute bottom-[17.83%] left-[7.73%] right-[79.91%] top-1/2" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15.53 11.9826">
            <path d={svgPaths.p2b5f2100} fill="url(#paint0_linear_1_1098)" id="Vector" />
            <defs>
              <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_1_1098" x1="13.3979" x2="-7.79293" y1="2.14143" y2="23.3229">
        ...
        <div className="absolute bottom-1/2 left-[7.73%] right-[79.91%] top-[17.83%]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15.53 11.9805">
            <path d={svgPaths.p6c4e600} fill="url(#paint0_linear_1_1092)" id="Vector" />
            <defs>
              <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_1_1092" x1="-2.92351" x2="6.536" y1="-6.47302" y2="2.98649">
...
function Frame16() {
  return (
    <div id="contact-us" data-nav="contact-us" className="absolute content-stretch flex flex-col items-center left-0 top-[7595px] w-[1440px]">
      <Frame4 />
      <Frame />
    </div>
  );
...
export default function EmergencyMedicalTechnician() {
  ...
  return (
    <div
      ...
      data-name="Emergency Medical Technician"
