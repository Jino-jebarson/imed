...
import imedLogoTMTag from "../HomePage/imedLogoTMTag.svg";
      ...
      <>
        ...
        <main className="slms-page slms-login-page">
          ...
          <form className="slms-login-card" onSubmit={login}>
            <div className="slms-brand"><img className="slms-brand-logo" src={imedLogoTMTag} alt="iMED Academy" /></div>
  ...
  return (
    <>
      ...
      <aside className={`slms-sidebar ${sidebarOpen ? "open" : ""}`}>
        <div className="slms-brand"><img className="slms-brand-logo" src={imedLogoTMTag} alt="iMED Academy" /><button type="button" className="slms-sidebar-close" aria-label="Close menu" onClick={() => setSidebarOpen(false)}><X size={17} /></button></div>
