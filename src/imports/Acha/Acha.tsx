...
import imgImage1723 from "./6216339a4edd8c73929f4b390920b7a12902a911.png";
import imgImage1724 from "./31dab1eea3af2b6c42b1fb4cc3f49442da9f0719.png";
...
const achaFaqItems = [
  ...
  },
  {
    ...
    answer:
      "Yes. The program structure supports working learners through guided modules and practical scheduling.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "It offers strong growth, leadership opportunities, and long-term demand across hospitals, health-tech, insurance, and operations.",
  },
];
...
function NavBar() {
  return (
    <div className="absolute bg-white content-stretch flex gap-[227px] h-[66px] items-center justify-center left-0 overflow-clip px-[38px] py-[15px] shadow-[0px_4px_4px_0px_rgba(40,53,147,0.15)] top-0 w-[1440px]" data-name="Nav Bar">
      <Frame139 />
      <Frame22 />
      <Button />
    </div>
...
function Frame74() {
  return (
    <div className="-translate-y-1/2 absolute content-stretch flex gap-[15px] items-center left-[15px] top-[calc(50%+0.5px)]">
      <Frame73 />
      <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[48px] not-italic relative shrink-0 text-[18px] text-black text-center whitespace-nowrap">GCC Readiness Track + Globally benchmarked Curriculum</p>
    </div>
  );
}
...
function Frame75() {
  return (
    <div className="-translate-y-1/2 absolute content-stretch flex gap-[15px] items-center left-[15px] top-[calc(50%+0.5px)]">
      <Frame76 />
      <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[48px] not-italic relative shrink-0 text-[18px] text-black text-center whitespace-nowrap">Advance Professional Skills Training</p>
    </div>
  );
}
...
function Frame77() {
  return (
    <div className="-translate-y-1/2 absolute content-stretch flex gap-[15px] items-center left-[15px] top-[calc(50%+0.5px)]">
      <Frame78 />
      <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[48px] not-italic relative shrink-0 text-[18px] text-black text-center whitespace-nowrap">{`Operations Excellence & Lean in Healthcare`}</p>
    </div>
  );
}
...
function Frame79() {
  return (
    <div className="-translate-y-1/2 absolute content-stretch flex gap-[15px] items-center left-[15px] top-[calc(50%+0.5px)]">
      <Frame80 />
      <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[48px] not-italic relative shrink-0 text-[18px] text-black text-center whitespace-nowrap">{`Healthcare Laws, Policy & Risk Management`}</p>
    </div>
  );
}
...
function Frame81() {
  return (
    <div className="-translate-y-1/2 absolute content-stretch flex gap-[15px] items-center left-[15px] top-[calc(50%+0.5px)]">
      <Frame87 />
      <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[48px] not-italic relative shrink-0 text-[18px] text-black text-center whitespace-nowrap">{`Healthcare Finance, P&L and Revenue Cycle Management`}</p>
    </div>
  );
}
...
function Frame89() {
  return (
    <div className="-translate-y-1/2 absolute content-stretch flex gap-[15px] items-center left-[15px] top-[calc(50%+0.5px)]">
      <Frame93 />
      <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[48px] not-italic relative shrink-0 text-[18px] text-black text-center whitespace-nowrap">{`Healthcare Analytics & Data-Driven Decision Making`}</p>
    </div>
  );
}
...
function Frame95() {
  return (
    <div className="-translate-y-1/2 absolute content-stretch flex gap-[15px] items-center left-[15px] top-[calc(50%+0.5px)]">
      <Frame96 />
      <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[48px] not-italic relative shrink-0 text-[18px] text-black text-center whitespace-nowrap">{`Healthcare Marketing, Branding & Patient Experience`}</p>
    </div>
  );
}
...
function Frame98() {
  return (
    <div className="-translate-y-1/2 absolute content-stretch flex gap-[15px] items-center left-[15px] top-[calc(50%+0.5px)]">
      <Frame99 />
      <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[48px] not-italic relative shrink-0 text-[18px] text-black text-center whitespace-nowrap">Capstone Project - Real Hospital Case</p>
    </div>
  );
}
...
function Frame104() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col items-start leading-[23px] not-italic relative shrink-0 text-[18px] w-[192px]">
      ...
      <p className="font-['Inter:Medium',sans-serif] font-medium relative shrink-0 text-[#333] text-center w-[281px]">9 Months (6 Months Class Room Training + 3 Months Internship)</p>
    </div>
  );
}
...
function Frame111() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col items-start leading-[23px] not-italic relative shrink-0 text-[18px] w-[192px]">
      ...
      <p className="font-['Inter:Medium',sans-serif] font-medium relative shrink-0 text-[#333] text-center whitespace-nowrap">Graduation</p>
    </div>
  );
}
...
function Frame118() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      ...
      <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[23px] not-italic relative shrink-0 text-[18px] text-center text-white whitespace-nowrap">Graduate in any discipline (healthcare background preferred)</p>
    </div>
  );
}
...
function Frame122() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0 w-full">
      ...
      <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[23px] not-italic relative shrink-0 text-[18px] text-center text-white whitespace-nowrap">Passion for healthcare management careers</p>
    </div>
  );
}
...
function Frame123() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      ...
      <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[23px] not-italic relative shrink-0 text-[18px] text-center text-white whitespace-nowrap">Basic understanding of hospital workflows</p>
    </div>
  );
}
...
function Frame124() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      ...
      <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[23px] not-italic relative shrink-0 text-[18px] text-center text-white whitespace-nowrap">Ability to handle hospital coordination tasks</p>
    </div>
  );
}
...
function Frame127() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[10px] items-start not-italic relative shrink-0 text-white w-[198px]">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[39px] relative shrink-0 text-[18px] w-full">{`Assistant Manager `}</p>
...
function Frame129() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[10px] items-start not-italic relative shrink-0 text-white w-[198px]">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[39px] relative shrink-0 text-[18px] w-[261px]">Sr. Manager / AVP</p>
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] min-w-full relative shrink-0 text-[25px] w-[min-content]">₹18 – 28 LPA</p>
    </div>
  );
}
...
function Frame132() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[10px] items-start not-italic relative shrink-0 text-white w-[198px]">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[39px] relative shrink-0 text-[18px] w-full">Manager - Operations</p>
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] relative shrink-0 text-[25px] w-full">₹10 – 16 LPA</p>
    </div>
  );
}
...
function Frame134() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[10px] items-start not-italic relative shrink-0 text-white w-[198px]">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[39px] relative shrink-0 text-[18px] w-[220px]">Director / VP Operations</p>
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] min-w-full relative shrink-0 text-[25px] w-[min-content]">₹28 LPA+</p>
    </div>
  );
}
...
function Frame32() {
  return (
    <div className="h-[517px] relative rounded-[15px] shrink-0 w-[499px]">
      <img loading="lazy" decoding="async" alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[15px] size-full" src={imgFrame2095585627} />
    </div>
  );
}
...
function Frame51() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      <MdiTick />
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[27px] not-italic relative shrink-0 text-[#333] text-[18px] whitespace-nowrap">Advanced curriculum co-designed with industry leaders</p>
    </div>
  );
}
...
function Frame54() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      <MdiTick1 />
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[27px] not-italic relative shrink-0 text-[#333] text-[18px] whitespace-nowrap">Faculty from leading hospital chains and consulting firms</p>
    </div>
  );
}
...
function Frame55() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      <MdiTick2 />
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[27px] not-italic relative shrink-0 text-[#333] text-[18px] whitespace-nowrap">Live case studies from real Indian and international hospitals</p>
    </div>
  );
}
...
function Frame56() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      <MdiTick3 />
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[27px] not-italic relative shrink-0 text-[#333] text-[18px] whitespace-nowrap">Leadership and executive communication coaching</p>
    </div>
  );
}
...
function Frame57() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      <MdiTick4 />
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[27px] not-italic relative shrink-0 text-[#333] text-[18px] w-[566px]">Networking with senior healthcare administrators</p>
    </div>
  );
}
...
function Frame58() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      <MdiTick5 />
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[27px] not-italic relative shrink-0 text-[#333] text-[18px] w-[566px]">Mentorship for senior career transitions</p>
    </div>
  );
}
...
function Frame59() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      <MdiTick6 />
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[27px] not-italic relative shrink-0 text-[#333] text-[18px] w-[566px]">Global healthcare standards exposure</p>
    </div>
  );
}
...
function Frame60() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      <MdiTick7 />
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[27px] not-italic relative shrink-0 text-[#333] text-[18px] w-[566px]">Hands-on hospital management projects</p>
    </div>
  );
}
...
function Heading15() {
  return (
    <div className="h-[48px] relative shrink-0 w-full" data-name="Heading 2">
      <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Inter:Bold',sans-serif] font-bold leading-[48px] left-[92.5px] not-italic text-[#25a88d] text-[20px] text-center top-0 whitespace-nowrap">Placement Support</p>
    </div>
  );
}
...
function Frame62() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      <MdiTick8 />
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[27px] not-italic relative shrink-0 text-[#333] text-[18px] whitespace-nowrap">Senior-role placement assistance with hospital chains</p>
    </div>
  );
}
...
function Frame63() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      <MdiTick9 />
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[27px] not-italic relative shrink-0 text-[#333] text-[18px] whitespace-nowrap">Executive resume and LinkedIn profile building</p>
    </div>
  );
}
...
function Frame64() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      <MdiTick10 />
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[27px] not-italic relative shrink-0 text-[#333] text-[18px] whitespace-nowrap">Mock interviews with senior healthcare HRs</p>
    </div>
  );
}
...
function Frame65() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      <MdiTick11 />
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[27px] not-italic relative shrink-0 text-[#333] text-[18px] whitespace-nowrap">Internal job posting access via iMED alumni network</p>
    </div>
  );
}
...
function Frame66() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      <MdiTick12 />
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[27px] not-italic relative shrink-0 text-[#333] text-[18px] w-[566px]">Career coaching for mid-to-senior role transitions</p>
    </div>
  );
}
...
function Frame67() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      <MdiTick13 />
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[27px] not-italic relative shrink-0 text-[#333] text-[18px] w-[566px]">Salary negotiation support for senior offers</p>
    </div>
  );
}
...
function Frame68() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      <MdiTick14 />
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[27px] not-italic relative shrink-0 text-[#333] text-[18px] w-[566px]">Career advancement planning support</p>
    </div>
  );
}
...
function Frame69() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      <MdiTick15 />
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[27px] not-italic relative shrink-0 text-[#333] text-[18px] w-[566px]">Access to healthcare industry connections</p>
    </div>
  );
}
...
function Text22() {
  return (
    <div className="absolute h-[20px] left-[-0.2px] top-[15.8px] w-[192.425px]" data-name="Text">
      <p className="[word-break:break-word] absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#0a0a0a] text-[20px] top-[-0.2px] whitespace-nowrap">Can I take this while working?</p>
    </div>
  );
}
...
function Text23() {
  return (
    <div className="absolute h-[20px] left-[-0.2px] top-[15.8px] w-[192.425px]" data-name="Text">
      <p className="[word-break:break-word] absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#0a0a0a] text-[20px] top-[-0.2px] whitespace-nowrap">Will I get a certificate?</p>
    </div>
  );
}
...
function Text25() {
  return (
    <div className="absolute h-[20px] left-[-0.2px] top-[15.8px] w-[192.425px]" data-name="Text">
      <p className="[word-break:break-word] absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#0a0a0a] text-[20px] top-[-0.2px] whitespace-nowrap">Is a capstone project included?</p>
    </div>
  );
}
...
function Text26() {
  return (
    <div className="absolute h-[20px] left-[-0.2px] top-[15.8px] w-[192.425px]" data-name="Text">
      <p className="[word-break:break-word] absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#0a0a0a] text-[20px] top-[-0.2px] whitespace-nowrap">Why should I choose a career in Hospital Administration?</p>
    </div>
  );
}
...
function About7({ openIndex, onToggle }: { openIndex: number | null; onToggle: (index: number) => void }) {
  return (
    <div className="-translate-x-1/2 absolute bg-white content-stretch flex flex-col gap-[39px] items-center left-1/2 px-[32px] py-[60px] top-[6375px] w-[1440px]" data-name="About">
      ...
      <div className="bg-white relative rounded-[14px] shrink-0 w-[848px]">
        <div className="content-stretch flex flex-col items-start overflow-clip p-[0.8px] relative rounded-[inherit] size-full">
          <div className="content-stretch flex flex-col items-start relative shrink-0 w-full">
            {achaFaqItems.map((item, index) => {
              const isOpen = openIndex === index;
              const isLast = index === achaFaqItems.length - 1;
              return (
                <div key={`${item.question}-${index}`} className={isLast ? "w-full" : "w-full border-b-[0.8px] border-[rgba(0,0,0,0.1)]"}>
                  <div className="content-stretch flex flex-col items-start px-[24px] py-[11px] relative w-full">
                    <button type="button" onClick={() => onToggle(index)} className="min-h-[52px] relative rounded-[8px] w-full text-left flex items-center justify-between gap-[12px]">
                      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic text-[#0a0a0a] text-[20px]">{item.question}</p>
                      <div className="shrink-0 size-[28px]">
                        <svg className={`block size-full transition-transform duration-200 ${isOpen ? "rotate-180" : ""}`} fill="none" preserveAspectRatio="none" viewBox="0 0 28 28">
                          <path d="M7 10.5L14 17.5L21 10.5" stroke="var(--stroke-0, #25A88D)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
                        </svg>
                      </div>
                    </button>
                    {isOpen && <p className="pb-[14px] pt-[4px] font-['Inter:Regular',sans-serif] font-normal leading-[27px] not-italic text-[#4a5565] text-[18px]">{item.answer}</p>}
                  </div>
                </div>
              );
            })}
      ...
      <div className="h-[37.242px] overflow-clip relative shrink-0 w-[125.692px]" data-name="Badge">
        ...
        <div className="absolute inset-[18.68%_83.04%_18.65%_7.38%]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12.0425 23.3415">
            <path d={svgPaths.p2192fa80} fill="url(#paint0_linear_1_1162)" id="Vector" />
            <defs>
              <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_1_1162" x1="11.0184" x2="-4.60472" y1="1.15451" y2="16.7776">
        ...
        <div className="absolute inset-[39.3%_75.52%_39.3%_16.96%]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 9.4502 7.96983">
            <path d={svgPaths.p14fc2800} fill="url(#paint0_linear_1_1118)" id="Vector" />
            <defs>
              <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_1_1118" x1="10.1764" x2="-12.3458" y1="3.98491" y2="3.98491">
        ...
        <div className="absolute bottom-[17.83%] left-[7.73%] right-[79.91%] top-1/2" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15.53 11.9826">
            <path d={svgPaths.p2b5f2100} fill="url(#paint0_linear_1_1078)" id="Vector" />
            <defs>
              <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_1_1078" x1="13.3979" x2="-7.79293" y1="2.14143" y2="23.3229">
        ...
        <div className="absolute bottom-1/2 left-[7.73%] right-[79.91%] top-[17.83%]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15.53 11.9805">
            <path d={svgPaths.p6c4e600} fill="url(#paint0_linear_1_1072)" id="Vector" />
            <defs>
              <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_1_1072" x1="-2.92351" x2="6.536" y1="-6.47302" y2="2.98649">
...
function Frame2() {
  const handleProgramClick = (route: string, scrollTarget?: string) => (event: MouseEvent<HTMLButtonElement>) => {
  ...
  return (
    <div className="content-stretch flex flex-col font-['Inter:Regular',sans-serif] font-normal gap-[16px] items-start relative shrink-0 text-[18px] text-white">
      <button type="button" onClick={handleProgramClick("#emt")} className="relative shrink-0 whitespace-nowrap text-left transition-colors duration-200 hover:text-[#8ee2d2]">Emergency Medical Technician</button>
...
function Frame3() {
  return (
    <div className="content-stretch flex flex-col font-['Inter:Regular',sans-serif] font-normal gap-[16px] items-start relative shrink-0 text-[18px] text-white w-full">
      <button type="button" onClick={() => document.getElementById("about-imed")?.scrollIntoView({ behavior: "smooth", block: "start" })} className="relative shrink-0 w-[111px] text-left transition-colors duration-200 hover:text-[#8ee2d2]">{`About Us`}</button>
      <button type="button" onClick={() => { window.location.hash = "#careers"; window.scrollTo({ top: 0, behavior: "smooth" }); }} className="min-w-full relative shrink-0 w-[min-content] text-left transition-colors duration-200 hover:text-[#8ee2d2]">{`Careers`}</button>
    </div>
  );
}
...
function Frame11() {
  return (
    <div className="col-1 content-stretch flex gap-[12px] items-center ml-0 mt-0 relative row-1">
      <a href="https://www.instagram.com/imed_academy_/" target="_blank" rel="noopener noreferrer" className="inline-flex" aria-label="Instagram"><Component /></a>
...
function Frame16() {
  return (
    <div id="contact-us" className="absolute content-stretch flex flex-col items-center left-0 top-[7581px] w-[1440px]">
      <Frame4 />
      <Frame />
    </div>
  );
    ...
    >
      ...
      >
        <div className="bg-white relative size-full">
          ...
          <About5 />
          <About6 />
          <About7 openIndex={openFaqIndex} onToggle={(index) => setOpenFaqIndex((prev) => (prev === index ? null : index))} />
          <Container41 />
          <Frame16 />
        </div>
      </div>
