...
import imgImage1746 from "./image1746.webp";
...
function Frame36() {
  return (
    <div className="content-stretch flex flex-col font-['Inter:Bold',sans-serif] font-bold items-start relative shrink-0 text-[50px]">
      ...
      <p className="h-[69px] leading-[70px] relative shrink-0 text-[#25a88d] w-[587px]">Hospital Administration</p>
    </div>
  );
}
  ...
  return (
    <div className="h-[50px] relative rounded-[12px] shrink-0 w-[210px] cursor-pointer">
      <div className="content-stretch flex items-center justify-center overflow-clip px-[17px] py-[8px] relative rounded-[inherit] size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[32.5px] not-italic relative shrink-0 text-[18px] text-white whitespace-nowrap">Talk to Experts</p>
      </div>
...
function Frame15() {
  return (
    <div id="imed-online" data-nav="imed-online" className="absolute bg-[#1f3471] h-[666px] left-0 overflow-clip top-[66px] w-[1440px]">
      <div className="-translate-x-1/2 -translate-y-1/2 absolute h-[668px] left-[calc(50%+271px)] top-[calc(50%-1px)] w-[1002px]" data-name="image 1722">
        <img loading="lazy" decoding="async" alt="" className="absolute inset-0 max-w-none object-cover opacity-47 pointer-events-none size-full" src={imgImage1722} />
      </div>
...
function Heading2() {
  return (
    <div className="h-[48px] relative shrink-0 w-full" data-name="Heading 3">
      <p className="-translate-x-1/2 absolute font-['Inter:Bold',sans-serif] font-bold leading-[48px] left-1/2 not-italic text-[#1f3471] text-[40px] text-center top-[-1px] whitespace-nowrap">What is Hospital Administration</p>
    </div>
  );
}
...
function Frame31() {
  return (
    <div className="bg-[#824747] h-[423px] overflow-clip relative rounded-[15px] shrink-0 w-[657px]">
      <div className="-translate-y-1/2 absolute h-[438px] left-0 top-[calc(50%+0.5px)] w-[657px]" data-name="image 1746">
        <img loading="lazy" decoding="async" alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgImage1746} />
      </div>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full">
      <div className="font-['Inter:Regular',sans-serif] font-normal leading-[0] not-italic relative shrink-0 text-[#4a5565] text-[20px] text-justify w-full whitespace-pre-wrap">
        <p className="leading-[32.5px] mb-0">Hospital Administration is the field that focuses on managing the overall operations and services of a healthcare facility. It involves planning, organizing, and coordinating hospital functions such as patient services, staff management, finance, and daily operations to ensure smooth and efficient healthcare delivery.</p>
        <p className="leading-[32.5px]">Professionals in hospital administration work behind the scenes to maintain quality care, improve patient experience, and ensure that the hospital runs effectively. They act as a bridge between medical staff and management, making strategic decisions, handling resources, and ensuring compliance with healthcare standards and regulations.</p>
      </div>
    </div>
  );
}
...
function Frame70() {
  return (
    <div className="-translate-y-1/2 absolute content-stretch flex gap-[15px] items-center left-[15px] top-[calc(50%+0.5px)]">
      <Frame69 />
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[48px] not-italic relative shrink-0 text-[18px] text-black text-center whitespace-nowrap">{`Hospital Operations & Workflow Management`}</p>
    </div>
  );
}
...
function Frame71() {
  return (
    <div className="-translate-y-1/2 absolute content-stretch flex gap-[15px] items-center left-[15px] top-[calc(50%+0.5px)]">
      <Frame72 />
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[48px] not-italic relative shrink-0 text-[18px] text-black text-center whitespace-nowrap">{`Patient Care Services & Front Office Management`}</p>
    </div>
  );
}
...
function Frame73() {
  return (
    <div className="-translate-y-1/2 absolute content-stretch flex gap-[15px] items-center left-[15px] top-[calc(50%+0.5px)]">
      <Frame74 />
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[48px] not-italic relative shrink-0 text-[18px] text-black text-center whitespace-nowrap">{`Quality, NABH & JCI Accreditation Standards`}</p>
    </div>
  );
}
...
function Frame75() {
  return (
    <div className="-translate-y-1/2 absolute content-stretch flex gap-[15px] items-center left-[15px] top-[calc(50%+0.5px)]">
      <Frame76 />
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[48px] not-italic relative shrink-0 text-[18px] text-black text-center whitespace-nowrap">{`Medical Records & Insurance Management`}</p>
    </div>
  );
}
...
function Frame77() {
  return (
    <div className="-translate-y-1/2 absolute content-stretch flex gap-[15px] items-center left-[15px] top-[calc(50%+0.5px)]">
      <Frame83 />
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[48px] not-italic relative shrink-0 text-[18px] text-black text-center whitespace-nowrap">{`Healthcare Finance & Accounting`}</p>
    </div>
  );
}
...
function Frame85() {
  return (
    <div className="-translate-y-1/2 absolute content-stretch flex gap-[15px] items-center left-[15px] top-[calc(50%+0.5px)]">
      <Frame89 />
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[48px] not-italic relative shrink-0 text-[18px] text-black text-center whitespace-nowrap">Healthcare Information Systems (HIS)</p>
    </div>
  );
}
...
function Frame91() {
  return (
    <div className="-translate-y-1/2 absolute content-stretch flex gap-[15px] items-center left-[15px] top-[calc(50%+0.5px)]">
      <Frame92 />
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[48px] not-italic relative shrink-0 text-[18px] text-black text-center whitespace-nowrap">{`Healthcare Laws, Ethics & Policy`}</p>
    </div>
  );
}
...
function Frame94() {
  return (
    <div className="-translate-y-1/2 absolute content-stretch flex gap-[15px] items-center left-[15px] top-[calc(50%+0.5px)]">
      <Frame95 />
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[48px] not-italic relative shrink-0 text-[18px] text-black text-center whitespace-nowrap">Strategic Management in Healthcare</p>
    </div>
  );
}
...
function Frame100() {
  return (
    <div className="content-stretch flex flex-col items-start leading-[23px] not-italic relative shrink-0 text-[18px] w-[192px]">
      ...
      <p className="font-['Inter:Medium',sans-serif] font-medium relative shrink-0 text-[#333] text-center w-[281px]">6 Months (3 Months Class Room Training + 3 Months Internship)</p>
    </div>
  );
}
...
function Frame117() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      ...
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[23px] not-italic relative shrink-0 text-[18px] text-center text-white whitespace-nowrap">Passed 12th (10+2) from a recognized board</p>
    </div>
  );
}
...
function Frame118() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0 w-full">
      ...
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[23px] not-italic relative shrink-0 text-[18px] text-center text-white whitespace-nowrap">Minimum 50% aggregate marks (45% for reserved categories)</p>
    </div>
  );
}
...
function Frame120() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      ...
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[23px] not-italic relative shrink-0 text-[18px] text-center text-white whitespace-nowrap">Basic English communication skills</p>
    </div>
  );
}
...
function Frame121() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      ...
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[23px] not-italic relative shrink-0 text-[18px] text-center text-white whitespace-nowrap">Personal interview with iMED admissions counselor</p>
    </div>
  );
}
...
function Frame42() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[764px]">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[32.5px] not-italic relative shrink-0 text-[#4a5565] text-[20px] text-justify w-full">{`India's healthcare industry is growing at over 22% annually and is expected to reach $638 billion by 2025. With thousands of new hospitals, diagnostic chains, insurance firms, and health-tech startups, the demand for trained hospital administrators has never been higher. BHA graduates have opportunities across hospitals, healthcare consultancies, insurance companies, pharma, and digital health platforms.`}</p>
    </div>
  );
}
...
function Frame130() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start not-italic relative shrink-0 text-white w-[198px]">
      ...
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] min-w-full relative shrink-0 text-[25px] w-[min-content]">25 LPA+</p>
    </div>
  );
}
...
function Frame32() {
  return (
    <div className="bg-[#824747] h-[517px] overflow-clip relative rounded-[15px] shrink-0 w-[499px]">
      <div className="-translate-x-1/2 absolute h-[755px] left-[calc(50%+2px)] top-[-47px] w-[503px]" data-name="image 1709">
...
function About3() {
  return (
    <div className="-translate-x-1/2 absolute bg-white content-stretch flex flex-col gap-[70px] items-center left-1/2 px-[34px] py-[60px] top-[2140px] w-[1440px]" data-name="About">
      <Frame47 />
      <Frame48 />
    </div>
  );
  ...
  return (
    <div className="h-[24px] relative shrink-0 w-[246px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[24px] left-0 not-italic text-[16px] text-white top-[-2.2px] whitespace-nowrap">CTC -&gt; Take-Home</p>
      </div>
    </div>
  );
}
...
function Text1() {
  return (
    <div className="h-[24px] relative shrink-0 w-[246px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-[-2.2px] whitespace-nowrap">Hospital Front Desk Coordinator</p>
      </div>
    </div>
  );
}
...
function Text3() {
  return (
    <div className="h-[24px] relative shrink-0 w-[119px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-[-2.2px] whitespace-nowrap">Multi-speciality</p>
      </div>
    </div>
  );
}
...
function Text4() {
  return (
    <div className="h-[20px] relative shrink-0 w-[34px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[20px] left-0 not-italic text-[#101828] text-[14px] top-[-0.2px] whitespace-nowrap">2 yrs</p>
      </div>
    </div>
  );
}
...
function Text7() {
  return (
    <div className="h-[24px] relative shrink-0 w-[70px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-[-2.2px] whitespace-nowrap">Day Shift</p>
      </div>
    </div>
  );
}
...
function Heading11() {
  return (
    <div className="absolute content-stretch flex h-[31.988px] items-start left-0 top-[48px] w-[573.6px]" data-name="Heading 2">
      <p className="flex-[1_0_0] font-['Inter:Bold',sans-serif] font-bold leading-[32px] min-w-px not-italic relative text-[24px] text-white">Hospital Front Desk Coordinator</p>
    </div>
  );
}
...
function Container17() {
  return (
    <div className="h-[48px] relative shrink-0 w-full" data-name="Container">
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[48px] left-0 not-italic text-[48px] text-white top-[-3px] whitespace-nowrap">56,265</p>
    </div>
  );
}
...
function Text11() {
  return (
    <div className="h-[20px] relative shrink-0 w-[50.025px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[20px] left-0 not-italic text-[14px] text-white top-[-0.2px] whitespace-nowrap">70,180</p>
      </div>
    </div>
  );
}
...
function Text13() {
  return (
    <div className="h-[24px] relative shrink-0 w-[54.725px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] left-0 not-italic text-[16px] text-white top-[-2.2px] whitespace-nowrap">39,386</p>
      </div>
    </div>
  );
}
...
function Text15() {
  return (
    <div className="h-[24px] relative shrink-0 w-[57.213px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] left-0 not-italic text-[16px] text-white top-[-2.2px] whitespace-nowrap">16,879</p>
      </div>
    </div>
  );
}
...
function Text17() {
  return (
    <div className="h-[24px] relative shrink-0 w-[69.912px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] left-0 not-italic text-[16px] text-white top-[-2.2px] whitespace-nowrap">6,75,180</p>
      </div>
    </div>
  );
}
...
function Text19() {
  return (
    <div className="h-[28px] relative shrink-0 w-[67.013px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[28px] left-0 not-italic text-[#46ecd5] text-[18px] top-[-1.4px] whitespace-nowrap">49,513</p>
      </div>
    </div>
  );
}
...
function Button6() {
  return (
    <div className="bg-[#00bba7] h-[56px] relative rounded-[26843500px] shrink-0 w-full" data-name="Button cursor-pointer">
  ...
  return (
    <div className="bg-[#824747] h-[565px] overflow-clip relative rounded-[15px] shrink-0 w-[620px]">
      <div className="-translate-x-1/2 -translate-y-1/2 absolute left-1/2 size-[620px] top-[calc(50%+27.74px)]" data-name="image 1723">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img loading="lazy" decoding="async" alt="" className="absolute h-full left-[-25%] max-w-none top-[-5.67%] w-[150%]" src={imgImage1723} />
        </div>
      </div>
...
function Frame51() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      <MdiTick />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[27px] not-italic relative shrink-0 text-[#333] text-[18px] whitespace-nowrap">{`Industry-aligned curriculum co-designed with hospital CEOs `}</p>
    </div>
  );
}
...
function Frame54() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      <MdiTick1 />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[27px] not-italic relative shrink-0 text-[#333] text-[18px] whitespace-nowrap">Faculty includes practicing Healthcare administrators</p>
    </div>
  );
}
...
function Frame55() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      <MdiTick2 />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[27px] not-italic relative shrink-0 text-[#333] text-[18px] whitespace-nowrap">Live case studies from real Indian hospitals</p>
    </div>
  );
}
...
function Frame56() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      <MdiTick3 />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[27px] not-italic relative shrink-0 text-[#333] text-[18px] whitespace-nowrap">Soft-skills, communication, and leadership training</p>
    </div>
  );
}
...
function Frame57() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      <MdiTick4 />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[27px] not-italic relative shrink-0 text-[#333] text-[18px] w-[566px]">Hands-on exposure to HIS, billing, and hospital management software</p>
    </div>
  );
}
...
function Frame58() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      <MdiTick5 />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[27px] not-italic relative shrink-0 text-[#333] text-[18px] w-[566px]">Mentorship from senior healthcare executives</p>
    </div>
  );
}
...
function Frame60() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      <MdiTick6 />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[27px] not-italic relative shrink-0 text-[#333] text-[18px] whitespace-nowrap">Dedicated placement cell with 100% placement assistance</p>
    </div>
  );
}
...
function Frame61() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      <MdiTick7 />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[27px] not-italic relative shrink-0 text-[#333] text-[18px] whitespace-nowrap">Resume building and LinkedIn profile workshops</p>
    </div>
  );
}
...
function Frame62() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      <MdiTick8 />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[27px] not-italic relative shrink-0 text-[#333] text-[18px] whitespace-nowrap">Mock interviews and group discussions</p>
    </div>
  );
}
...
function Frame63() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      <MdiTick9 />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[27px] not-italic relative shrink-0 text-[#333] text-[18px] whitespace-nowrap">Direct hiring drives with 50+ partner hospitals</p>
    </div>
  );
}
...
function Frame64() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      <MdiTick10 />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[27px] not-italic relative shrink-0 text-[#333] text-[18px] w-[566px]">Internship-to-job conversion opportunities</p>
    </div>
  );
}
...
function Frame65() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      <MdiTick11 />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[27px] not-italic relative shrink-0 text-[#333] text-[18px] w-[566px]">Lifetime career support and alumni network access</p>
    </div>
  );
}
...
function About6() {
  return (
    <div className="-translate-x-1/2 absolute bg-white content-stretch flex gap-[40px] items-start left-1/2 pl-[69px] pr-[32px] py-[60px] top-[5700px] w-[1440px]" data-name="About">
      <Frame59 />
      <Frame34 />
    </div>
  );
...
function Text20() {
  return (
    <div className="absolute h-[20px] left-[-0.2px] top-[15.8px] w-[192.425px]" data-name="Text">
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#0a0a0a] text-[20px] top-[-0.2px] whitespace-nowrap">What is Hospital Administration?</p>
    </div>
  );
}
...
function Text21() {
  return (
    <div className="absolute h-[20px] left-[-0.2px] top-[15.8px] w-[192.425px]" data-name="Text">
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#0a0a0a] text-[20px] top-[-0.2px] whitespace-nowrap">Who can pursue a career in Hospital Administration?</p>
    </div>
  );
}
...
function Text22() {
  return (
    <div className="absolute h-[20px] left-[-0.2px] top-[15.8px] w-[192.425px]" data-name="Text">
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#0a0a0a] text-[20px] top-[-0.2px] whitespace-nowrap">What skills are required for Hospital Administration?</p>
    </div>
  );
}
...
function Text23() {
  return (
    <div className="absolute h-[20px] left-[-0.2px] top-[15.8px] w-[192.425px]" data-name="Text">
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#0a0a0a] text-[20px] top-[-0.2px] whitespace-nowrap">Is Hospital Administration a good career choice in India?</p>
    </div>
  );
}
...
function Text24() {
  return (
    <div className="absolute h-[20px] left-[-0.2px] top-[15.8px] w-[192.425px]" data-name="Text">
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#0a0a0a] text-[20px] top-[-0.2px] whitespace-nowrap">Can non-medical students study Hospital Administration?</p>
    </div>
  );
}
...
function Text25() {
  return (
    <div className="absolute h-[20px] left-[-0.2px] top-[15.8px] w-[192.425px]" data-name="Text">
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#0a0a0a] text-[20px] top-[-0.2px] whitespace-nowrap">What is the salary scope in Hospital Administration?</p>
    </div>
  );
}
...
function Text26() {
  return (
    <div className="absolute h-[20px] left-[-0.2px] top-[15.8px] w-[192.425px]" data-name="Text">
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#0a0a0a] text-[20px] top-[-0.2px] whitespace-nowrap">How do I apply?</p>
    </div>
  );
}
...
const haFaqQuestions = [
  "What is Hospital Administration?",
  "What skills are required for Hospital Administration?",
  "Is Hospital Administration a good career choice in India?",
  "Can non-medical students study Hospital Administration?",
  "What is the salary scope in Hospital Administration?",
  "How do I apply?",
];

const haAnswerIntros = [
  "Great question.",
  "This comes up a lot from new learners.",
  "Short answer:",
  "Yes, and here is the context.",
];

const haAnswerOutros = [
  "Our team can help you choose the right pathway based on your profile.",
  "Career growth depends on skills, location, and role specialization.",
  "We support students from enrollment to placement preparation.",
  "You can speak to our counselor for role-specific guidance.",
];

function buildHaRandomAnswer(question: string) {
  const intro = haAnswerIntros[Math.floor(Math.random() * haAnswerIntros.length)];
  const outro = haAnswerOutros[Math.floor(Math.random() * haAnswerOutros.length)];
  return `${intro} For "${question}", Hospital Administration prepares you for healthcare operations, patient-services coordination, and management workflows. ${outro}`;
}

function Container33() {
  const [openIndex, setOpenIndex] = useState(-1);
  const [faqItems] = useState(() =>
    haFaqQuestions.map((question) => ({
      question,
      answer: buildHaRandomAnswer(question),
    })),
  );
  ...
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      {faqItems.map((item, index) => {
        ...
        return (
          <div key={`${item.question}-${index}`} className="relative shrink-0 w-full">
            <div aria-hidden="true" className="absolute border-[rgba(0,0,0,0.1)] border-b-[0.8px] border-solid inset-0 pointer-events-none" />
            <button
              type="button"
...
function About7() {
  return (
    <div className="-translate-x-1/2 absolute bg-white content-stretch flex flex-col gap-[39px] items-center left-1/2 px-[32px] py-[60px] top-[6385px] w-[1440px]" data-name="About">
      <Container31 />
      <Container32 />
    </div>
  );
...
function Heading19() {
  return (
    <div className="content-stretch flex h-[36px] items-start relative shrink-0 w-[905px]" data-name="Heading 3">
      <p className="flex-[1_0_0] font-['Inter:Bold',sans-serif] font-bold leading-[36px] min-w-px not-italic relative text-[30px] text-center text-white">Ready to start your HA journey?</p>
    </div>
  );
}
...
function Container41() {
  return (
    <div className="-translate-x-1/2 absolute content-stretch flex flex-col gap-[23px] h-[387px] items-center justify-center left-[calc(50%+0.5px)] px-[52px] py-[60px] shadow-[0px_25px_50px_0px_rgba(0,0,0,0.25)] top-[7204px] w-[1459px]" style={{ backgroundImage: "linear-gradient(99.3413deg, rgb(0, 62, 156) 6.0505%, rgb(0, 120, 218) 92.71%)" }} data-name="Container">
      <Heading19 />
      <Paragraph5 />
      <Frame28 />
    </div>
      ...
      <div className="h-[37.242px] overflow-clip relative shrink-0 w-[125.692px]" data-name="Badge">
        ...
        <div className="absolute inset-[18.68%_83.04%_18.65%_7.38%]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12.0425 23.3415">
            <path d={svgPaths.p2192fa80} fill="url(#paint0_linear_1_217)" id="Vector" />
            <defs>
              <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_1_217" x1="11.0184" x2="-4.60472" y1="1.15451" y2="16.7776">
        ...
        <div className="absolute inset-[39.3%_75.52%_39.3%_16.96%]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 9.4502 7.96983">
            <path d={svgPaths.p14fc2800} fill="url(#paint0_linear_1_156)" id="Vector" />
            <defs>
              <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_1_156" x1="10.1764" x2="-12.3458" y1="3.98491" y2="3.98491">
        ...
        <div className="absolute bottom-[17.83%] left-[7.73%] right-[79.91%] top-1/2" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15.53 11.9826">
            <path d={svgPaths.p2b5f2100} fill="url(#paint0_linear_1_150)" id="Vector" />
            <defs>
              <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_1_150" x1="13.3979" x2="-7.79293" y1="2.14143" y2="23.3229">
        ...
        <div className="absolute bottom-1/2 left-[7.73%] right-[79.91%] top-[17.83%]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15.53 11.9805">
            <path d={svgPaths.p6c4e600} fill="url(#paint0_linear_1_144)" id="Vector" />
            <defs>
              <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_1_144" x1="-2.92351" x2="6.536" y1="-6.47302" y2="2.98649">
...
function Frame2() {
  const handleProgramClick = (route: string) => (event: MouseEvent<HTMLButtonElement>) => {
...
function Frame16() {
  return (
    <div id="contact-us" data-nav="contact-us" className="absolute content-stretch flex flex-col items-center left-0 top-[7591px] w-[1440px]">
      <Frame4 />
      <Frame />
    </div>
  );
...
export default function HospitalAdministration() {
  ...
  return (
    <div
      ...
      data-name="Hospital Administration"
