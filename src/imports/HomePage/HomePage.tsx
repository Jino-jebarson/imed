...
function Group35() {
  ...
  return (
    <div
      ...
      className="content-stretch flex gap-[10px] items-center leading-[0] relative shrink-0 w-[203px] cursor-pointer [&>p]:hidden transition-transform duration-200 hover:scale-[1.02]"
    >
      <Group34 />
...
function Button() {
  return (
    <div data-nav-target="contact-us" className="bg-[#25a88d] content-stretch flex h-[36px] items-center justify-center px-[16px] py-[8px] relative rounded-[8px] shrink-0 w-[140px] cursor-pointer hover:opacity-95 transition-opacity" data-name="Button">
...
function Frame24() {
  return (
    <div data-nav-target="contact-us" className="bg-[#25a88d] content-stretch flex h-[50px] items-center justify-center overflow-clip px-[17px] py-[8px] relative rounded-[12px] shrink-0 w-[220px] cursor-pointer hover:opacity-95 transition-opacity">
