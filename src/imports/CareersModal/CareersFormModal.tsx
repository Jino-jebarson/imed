...
export default function CareersFormModal({ onClose }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-[120]">
      ...
      <div className="absolute left-1/2 top-1/2 max-h-[94vh] w-[96vw] max-w-[1200px] -translate-x-1/2 -translate-y-1/2 overflow-y-auto rounded-[18px] bg-white shadow-[0px_24px_45px_rgba(15,23,43,0.35)]">
        <div className="grid min-h-[909px] grid-cols-1 md:grid-cols-[466px_1fr]">
          ...
          <div className="px-[22px] py-[24px] md:px-[34px] md:py-[29px]">
            <div className="mb-[28px] flex items-start justify-between">
              ...
              <button type="button" onClick={onClose} className="inline-flex h-[53px] w-[53px] items-center justify-center rounded-[10px] bg-[rgba(37,168,141,0.15)] text-[28px] leading-none text-[#25a88d]">&times;</button>
            </div>
            ...
            <form onSubmit={submitCareer} className="space-y-[22px]">
              ...
              <div className="flex flex-col-reverse gap-[12px] pt-[6px] sm:flex-row sm:justify-end">
                <button type="button" onClick={onClose} className="h-[54px] rounded-[5px] border border-[#25a88d] px-[34px] font-['Inter:Medium',sans-serif] text-[19px] text-[#25a88d]">Cancel</button>
