...
import imgImage1723 from "./ochaAdvantage.svg";
import imgImage1724 from "./ochaBusiness.svg";
import imgImage1718 from "./5915099e30d31d9fe1c6e5f291809fe3439e9de6.png";
import { useLayoutEffect, useRef, useState } from "react";

type OchaFaqItem = { question: string; answer: string };

const ochaFaqItems: OchaFaqItem[] = [
  { question: "What is OCHA?", answer: "OCHA is iMED Academy's Online Certificate in Hospital Administration focused on practical non-clinical healthcare operations skills." },
  { question: "Is this course fully online?", answer: "Yes. Classes and learning content are delivered online so you can learn from anywhere." },
  { question: "Who should take this course?", answer: "12th-pass students, graduates, and working professionals who want a career in hospital operations and administration." },
  { question: "Will I get a certificate?", answer: "Yes. You receive a course completion certificate from iMED Academy after successfully completing the program." },
  { question: "Can I work while studying?", answer: "Yes. The format is designed to support learners who are studying while managing work or other commitments." },
  { question: "What is the duration of the course?", answer: "The OCHA journey is structured as a short-term job-focused program with guided modules and mentoring." },
  { question: "Are there any prerequisites to join this course?", answer: "Basic communication skills and willingness to learn healthcare administration concepts are enough to start." },
];
...
const defaultSelections: ScopeDemandSelections = {
  healthcareRole: "Hospital Administration",
...
let scopeDemandSelectionsView: ScopeDemandSelections = defaultSelections;
let salaryBreakdownView = computeSalaryBreakdown(defaultSelections);
let updateScopeDemandSelection: <K extends keyof ScopeDemandSelections>(key: K, value: ScopeDemandSelections[K]) => void = () => {};
...
const footerCompanyLinks = [
  { label: "About Us", target: "about-imed", className: "relative shrink-0 text-left w-[111px] cursor-pointer transition-colors duration-200 hover:text-[#8ee2d2]" },
  // { label: "Hospital Partners", target: "trusted-partners", className: "relative shrink-0 text-left whitespace-nowrap transition-colors duration-200 hover:text-[#8ee2d2] cursor-pointer" },
  { label: "Careers", hash: "#careers", className: "min-w-full relative shrink-0 text-left w-[min-content] transition-colors duration-200 hover:text-[#8ee2d2]" },
];

const footerLegalLinks = [
  { label: "Privacy Policy", hash: "#privacy-policy" },
  { label: "Terms of use", hash: "#terms-and-conditions" },
];

const footerContactItems = [
  { label: "contact@imedacademy.in", icon: "email" },
  { label: "+91 92667 90357", icon: "phone" },
] as const;

const navbarLinks = [
  { label: "Program", target: "career-path" },
  { label: "About Us", target: "about-imed" },
  { label: "Contact Us", target: "contact-us" },
];

function scrollToOchaSection(target: string) {
  if (target === "home") {
...
function handleFooterNavigation(item: { hash?: string; target?: string }) {
...
function NavBar() {
  return (
    <div className="bg-white flex h-[66px] items-center justify-between overflow-visible px-[38px] shadow-[0px_4px_4px_0px_rgba(40,53,147,0.15)] w-[1440px]" data-name="Nav Bar">
      <Frame135 />
      <Frame22 />
      <Button />
    </div>
...
function Frame36() {
  return (
    <div className="content-stretch flex flex-col font-['Inter:Bold',sans-serif] font-bold items-start leading-[70px] relative shrink-0 text-[50px]">
      <p className="h-[69px] relative shrink-0 text-white w-[544px]">Online Certification in</p>
...
function Frame27() {
  return (
    <div className="-translate-y-1/2 absolute content-stretch flex flex-col gap-[30px] h-[336px] items-start left-[67px] top-1/2 w-[732px]">
      <Frame26 />
      <Frame25 />
    </div>
  );
...
function Frame16() {
  return (
    <div id="home" className="absolute bg-[#1f3471] h-[666px] left-0 overflow-clip top-[66px] w-[1440px]">
      ...
      <div className="absolute bg-gradient-to-r from-[#1f3471] from-[12.981%] h-[665px] left-[489px] to-[rgba(31,52,113,0)] top-px w-[312px]" />
      <Frame27 />
    </div>
  );
}
...
function Heading1() {
  return (
    <div className="h-[48px] relative shrink-0 w-full" data-name="Heading 2">
      <p className="-translate-x-1/2 absolute font-['Inter:Bold',sans-serif] font-bold leading-[48px] left-1/2 not-italic text-[#25a88d] text-[20px] text-center top-[-1px] whitespace-nowrap">Program Overview</p>
    </div>
  );
}
...
function Heading2() {
  return (
    <div className="h-[48px] relative shrink-0 w-full" data-name="Heading 3">
      <p className="-translate-x-1/2 absolute font-['Inter:Bold',sans-serif] font-bold leading-[48px] left-[calc(50%+0.5px)] not-italic text-[#1f3471] text-[40px] text-center top-[-1px] whitespace-nowrap">What is Online Certificate in Hospital Administration?</p>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full">
      <div className="font-['Inter:Regular',sans-serif] font-normal leading-[0] not-italic relative shrink-0 text-[#4a5565] text-[20px] text-justify w-full whitespace-pre-wrap">
        <p className="leading-[32.5px] mb-0">The Online Certificate in Hospital Administration (OCHA) is a flexible, industry-focused program designed for working professionals, graduates, and 12th-pass students who want to build foundational skills in healthcare facility management from anywhere in India.</p>
        <p className="leading-[32.5px] mb-0">​</p>
        <p className="leading-[32.5px]">OCHA covers the essentials of hospital operations, patient services, medical records, billing, quality standards, and healthcare communication. It is a non-clinical certificate that equips learners to take up entry-level hospital management roles or strengthen their existing healthcare careers entirely through online learning.</p>
      </div>
    </div>
  );
}
...
function About() {
  return (
    <div id="about-imed" className="-translate-x-1/2 absolute bg-white content-stretch flex flex-col gap-[70px] items-center left-1/2 py-[60px] top-[732px] w-[1440px]" data-name="About">
      <Frame44 />
      <Frame43 />
    </div>
  );
...
function Heading3() {
  return (
    <div className="h-[48px] relative shrink-0 w-full" data-name="Heading 2">
      <p className="-translate-x-1/2 absolute font-['Inter:Bold',sans-serif] font-bold leading-[48px] left-[calc(50%+0.5px)] not-italic text-[#25a88d] text-[20px] text-center top-[-1px] whitespace-nowrap">Curriculum Highlights</p>
    </div>
  );
}
...
function Frame70() {
  return (
    <div className="-translate-y-1/2 absolute content-stretch flex gap-[15px] items-center left-[15px] top-[calc(50%+0.5px)]">
      <Frame69 />
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[48px] not-italic relative shrink-0 text-[18px] text-black text-center whitespace-nowrap">Introduction to Hospital Administration</p>
    </div>
  );
}
...
function Frame71() {
  return (
    <div className="-translate-y-1/2 absolute content-stretch flex gap-[15px] items-center left-[15px] top-[calc(50%+0.5px)]">
      <Frame72 />
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[48px] not-italic relative shrink-0 text-[18px] text-black text-center whitespace-nowrap">{`Patient Services & Front Office Management`}</p>
    </div>
  );
}
...
function Frame73() {
  return (
    <div className="-translate-y-1/2 absolute content-stretch flex gap-[15px] items-center left-[15px] top-[calc(50%+0.5px)]">
      <Frame74 />
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[48px] not-italic relative shrink-0 text-[18px] text-black text-center whitespace-nowrap">{`Hospital Billing & Insurance Fundamentals`}</p>
    </div>
  );
}
...
function Frame75() {
  return (
    <div className="-translate-y-1/2 absolute content-stretch flex gap-[15px] items-center left-[15px] top-[calc(50%+0.5px)]">
      <Frame76 />
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[48px] not-italic relative shrink-0 text-[18px] text-black text-center whitespace-nowrap">{`Healthcare Communication & Soft Skills`}</p>
    </div>
  );
}
...
function Frame77() {
  return (
    <div className="-translate-y-1/2 absolute content-stretch flex gap-[15px] items-center left-[15px] top-[calc(50%+0.5px)]">
      <Frame83 />
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[48px] not-italic relative shrink-0 text-[18px] text-black text-center whitespace-nowrap">{`Healthcare Operations & Workflow`}</p>
    </div>
  );
}
...
function Frame85() {
  return (
    <div className="-translate-y-1/2 absolute content-stretch flex gap-[15px] items-center left-[15px] top-[calc(50%+0.5px)]">
      <Frame89 />
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[48px] not-italic relative shrink-0 text-[18px] text-black text-center whitespace-nowrap">{`Medical Records & Health Information Basics`}</p>
    </div>
  );
}
...
function Frame91() {
  return (
    <div className="-translate-y-1/2 absolute content-stretch flex gap-[15px] items-center left-[15px] top-[calc(50%+0.5px)]">
      <Frame92 />
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[48px] not-italic relative shrink-0 text-[18px] text-black text-center whitespace-nowrap">{`Quality Standards & NABH Awareness`}</p>
    </div>
  );
}
...
function Frame94() {
  return (
    <div className="-translate-y-1/2 absolute content-stretch flex gap-[15px] items-center left-[15px] top-[calc(50%+0.5px)]">
      <Frame95 />
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[48px] not-italic relative shrink-0 text-[18px] text-black text-center whitespace-nowrap">Capstone Project / Case Study</p>
    </div>
  );
}
...
function About1() {
  return (
    <div id="career-path" className="-translate-x-1/2 absolute bg-white content-stretch flex flex-col gap-[70px] items-center left-1/2 px-[32px] py-[60px] top-[1465px] w-[1440px]" data-name="About">
      <Frame45 />
      <Frame88 />
    </div>
  );
...
function Heading5() {
  return (
    <div className="h-[48px] relative shrink-0 w-full" data-name="Heading 2">
      <p className="-translate-x-1/2 absolute font-['Inter:Bold',sans-serif] font-bold leading-[48px] left-1/2 not-italic text-[#25a88d] text-[20px] text-center top-[-1px] whitespace-nowrap">Program Details</p>
    </div>
  );
}
...
function Frame100() {
  return (
    <div className="content-stretch flex flex-col items-start leading-[23px] not-italic relative shrink-0 text-[18px] w-[192px]">
      ...
      <p className="font-['Inter:Medium',sans-serif] font-medium relative shrink-0 text-[#333] text-center w-[281px]">8 Weeks + 3 Months Internship</p>
    </div>
  );
}
...
function Frame112() {
  return (
    <div className="content-stretch flex flex-col items-start leading-[23px] not-italic relative shrink-0 text-[18px] w-[192px]">
      ...
      <p className="font-['Inter:Medium',sans-serif] font-medium relative shrink-0 text-[#333] text-center whitespace-nowrap">Online / Hybrid</p>
    </div>
  );
}
...
function Frame110() {
  return (
    <div className="content-stretch flex flex-col gap-[60px] items-start relative shrink-0 w-[555px]">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[23px] not-italic relative shrink-0 text-[30px] text-white w-full">Course details</p>
      <Frame103 />
    </div>
  );
}
...
function Frame117() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      ...
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[23px] not-italic relative shrink-0 text-[18px] text-center text-white whitespace-nowrap">12th pass from a recognized board (any stream)</p>
    </div>
  );
}
...
function Frame118() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0 w-full">
      ...
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[23px] not-italic relative shrink-0 text-[18px] text-center text-white whitespace-nowrap">Working professionals or graduates looking to upskill</p>
    </div>
  );
}
...
function Frame119() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      ...
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[23px] not-italic relative shrink-0 text-[18px] text-center text-white whitespace-nowrap">Basic computer and internet access</p>
    </div>
  );
}
...
function Frame120() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      ...
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[23px] not-italic relative shrink-0 text-[18px] text-center text-white whitespace-nowrap">English communication proficiency (basic level)</p>
    </div>
  );
}
...
function Frame121() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      ...
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[23px] not-italic relative shrink-0 text-[18px] text-center text-white whitespace-nowrap">Self-motivated learners comfortable with online study</p>
    </div>
  );
}
...
function Frame113() {
  return (
    <div className="content-stretch flex flex-col gap-[60px] items-start relative shrink-0 w-full">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[23px] not-italic relative shrink-0 text-[30px] text-white w-full">Admission requirements</p>
      <Frame114 />
    </div>
  );
}
...
function Frame42() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[764px]">
      <p className="font-['Inter:Regular',sans-serif] font-normal h-[194px] leading-[32.5px] not-italic relative shrink-0 text-[#4a5565] text-[20px] text-justify w-full">{`India's healthcare sector is rapidly digitizing, creating demand for professionals who understand hospital workflows, billing systems, and patient coordination. OCHA graduates can enter hospital administration, clinic management, health tech operations, and insurance processing roles across the country.`}</p>
    </div>
  );
}
...
function Frame123() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start not-italic relative shrink-0 text-white w-[198px]">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[39px] relative shrink-0 text-[18px] w-full">Entry-Level HA</p>
...
function Container() {
  return (
    <div className="content-stretch flex h-[124px] items-center justify-center overflow-clip relative rounded-[12px] shrink-0 w-full transition-all duration-300 cursor-pointer hover:-translate-y-1 hover:brightness-110 hover:shadow-[0px_14px_30px_rgba(37,168,141,0.28)]" style={{ backgroundImage: "linear-gradient(113.994deg, rgb(53, 80, 159) 6.5327%, rgb(26, 56, 144) 53.048%, rgb(59, 99, 215) 99.563%)" }} data-name="Container">
      <Frame122 />
    </div>
  );
}
...
function Frame128() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start not-italic relative shrink-0 text-white w-[198px]">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[39px] relative shrink-0 text-[18px] w-full">Ward Assistant</p>
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] relative shrink-0 text-[25px] w-full">₹3 – 4.5 LPA</p>
    </div>
  );
}
...
function Frame130() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start not-italic relative shrink-0 text-white w-[198px]">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[39px] relative shrink-0 text-[18px] w-[220px]">Home Care Lead</p>
...
function Frame32() {
  return (
    <div className="bg-[#824747] h-[517px] overflow-clip relative rounded-[15px] shrink-0 w-[499px]">
      <div className="-translate-x-1/2 absolute h-[755px] left-[calc(50%+2px)] top-[-82px] w-[503px]" data-name="image 1709">
  ...
  return (
    <div className="h-[24px] relative shrink-0 w-[246px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[24px] left-0 not-italic text-[16px] text-white top-[-2.2px] whitespace-nowrap">Career Growth</p>
      </div>
    </div>
  );
}
...
function Label() {
  return (
    <div className="absolute content-stretch flex h-[19px] items-start left-0 top-[3px] w-[106px]" data-name="Label">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#364153] text-[14px] whitespace-nowrap">Healthcare Role</p>
    </div>
  );
}
...
function Text1() {
  return (
    <div className="h-[24px] relative shrink-0 w-[246px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-[-2.2px] whitespace-nowrap">{scopeDemandSelectionsView.healthcareRole}</p>
      </div>
    </div>
  );
}
...
function Button2() {
  return (
    <div className="absolute bg-white content-stretch flex h-[50px] items-center justify-between left-0 px-[16.8px] py-[12.8px] rounded-[10px] top-[24px] w-[540px]" data-name="Button">
      <div aria-hidden="true" className="absolute border-[#d1d5dc] border-[0.8px] border-solid inset-0 pointer-events-none rounded-[10px]" />
      <select aria-label="Healthcare Role" className="bg-transparent cursor-pointer font-['Inter:Medium',sans-serif] font-medium h-full leading-[24px] not-italic outline-none pr-[28px] text-[#101828] text-[16px] w-full appearance-none" onChange={(event) => updateScopeDemandSelection("healthcareRole", event.target.value)} value={scopeDemandSelectionsView.healthcareRole}>
        {HEALTHCARE_ROLE_OPTIONS.map((option) => (
          <option key={option} value={option}>{option}</option>
        ))}
      </select>
      <div className="pointer-events-none"><Icon1 /></div>
    </div>
  );
}
...
function Label1() {
  return (
    <div className="absolute content-stretch flex h-[18px] items-start left-0 top-[3.4px] w-[60px]" data-name="Label">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#364153] text-[14px] whitespace-nowrap">City Tier</p>
    </div>
  );
}
...
function Text2() {
  return (
    <div className="h-[24px] relative shrink-0 w-[104px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-[-2.2px] whitespace-nowrap">{scopeDemandSelectionsView.cityTier}</p>
      </div>
    </div>
  );
}
...
function Button3() {
  return (
    <div className="absolute bg-white content-stretch flex h-[49px] items-center justify-between left-0 px-[16.8px] py-[12.8px] rounded-[10px] top-[24.4px] w-[540px]" data-name="Button">
      <div aria-hidden="true" className="absolute border-[#d1d5dc] border-[0.8px] border-solid inset-0 pointer-events-none rounded-[10px]" />
      <select aria-label="City Tier" className="bg-transparent cursor-pointer font-['Inter:Medium',sans-serif] font-medium h-full leading-[24px] not-italic outline-none pr-[28px] text-[#101828] text-[16px] w-full appearance-none" onChange={(event) => updateScopeDemandSelection("cityTier", event.target.value)} value={scopeDemandSelectionsView.cityTier}>
        {CITY_TIER_OPTIONS.map((option) => (
          <option key={option} value={option}>{option}</option>
        ))}
      </select>
      <div className="pointer-events-none"><Icon2 /></div>
    </div>
  );
}
...
function Label2() {
  return (
    <div className="absolute content-stretch flex h-[19px] items-start left-0 top-[2.8px] w-[92px]" data-name="Label">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#364153] text-[14px] whitespace-nowrap">Hospital Type</p>
    </div>
  );
}
...
function Text3() {
  return (
    <div className="h-[24px] relative shrink-0 w-[119px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-[-2.2px] whitespace-nowrap">{scopeDemandSelectionsView.hospitalType}</p>
      </div>
    </div>
  );
}
...
function Button4() {
  return (
    <div className="absolute bg-white content-stretch flex h-[50px] items-center justify-between left-0 px-[16.8px] py-[12.8px] rounded-[10px] top-[23.8px] w-[540px]" data-name="Button">
      <div aria-hidden="true" className="absolute border-[#d1d5dc] border-[0.8px] border-solid inset-0 pointer-events-none rounded-[10px]" />
      <select aria-label="Hospital Type" className="bg-transparent cursor-pointer font-['Inter:Medium',sans-serif] font-medium h-full leading-[24px] not-italic outline-none pr-[28px] text-[#101828] text-[16px] w-full appearance-none" onChange={(event) => updateScopeDemandSelection("hospitalType", event.target.value)} value={scopeDemandSelectionsView.hospitalType}>
        {HOSPITAL_TYPE_OPTIONS.map((option) => (
          <option key={option} value={option}>{option}</option>
        ))}
      </select>
      <div className="pointer-events-none"><Icon3 /></div>
    </div>
  );
}
...
function Text4() {
  return (
    <div className="h-[20px] relative shrink-0 w-[34px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[20px] left-0 not-italic text-[#101828] text-[14px] top-[-0.2px] whitespace-nowrap">{scopeDemandSelectionsView.experienceYears} yrs</p>
      </div>
    </div>
  );
}
...
function RangeSlider() {
  return <input aria-label="Experience in years" className="absolute left-0 top-[34px] w-[540px] accent-[#25a88d]" data-name="Range Slider" max={15} min={0} onChange={(event) => updateScopeDemandSelection("experienceYears", Number(event.target.value))} step={1} type="range" value={scopeDemandSelectionsView.experienceYears} />;
}
...
function Label4() {
  return (
    <div className="absolute content-stretch flex h-[19px] items-start left-0 top-[2.81px] w-[34px]" data-name="Label">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#364153] text-[14px] whitespace-nowrap">Shift</p>
    </div>
  );
}
...
function Text7() {
  return (
    <div className="h-[24px] relative shrink-0 w-[70px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[24px] left-0 not-italic text-[#101828] text-[16px] top-[-2.2px] whitespace-nowrap">{scopeDemandSelectionsView.shift}</p>
      </div>
    </div>
  );
}
...
function Button5() {
  return (
    <div className="absolute bg-white content-stretch flex h-[50px] items-center justify-between left-0 px-[16.8px] py-[12.8px] rounded-[10px] top-[23.81px] w-[540px]" data-name="Button">
      <div aria-hidden="true" className="absolute border-[#d1d5dc] border-[0.8px] border-solid inset-0 pointer-events-none rounded-[10px]" />
      <select aria-label="Shift" className="bg-transparent cursor-pointer font-['Inter:Medium',sans-serif] font-medium h-full leading-[24px] not-italic outline-none pr-[28px] text-[#101828] text-[16px] w-full appearance-none" onChange={(event) => updateScopeDemandSelection("shift", event.target.value)} value={scopeDemandSelectionsView.shift}>
        {SHIFT_OPTIONS.map((option) => (
          <option key={option} value={option}>{option}</option>
        ))}
      </select>
      <div className="pointer-events-none"><Icon4 /></div>
    </div>
  );
}
...
function Heading11() {
  return (
    <div className="absolute content-stretch flex h-[31.988px] items-start left-0 top-[48px] w-[573.6px]" data-name="Heading 2">
      <p className="flex-[1_0_0] font-['Inter:Bold',sans-serif] font-bold leading-[32px] min-w-px not-italic relative text-[24px] text-white">{scopeDemandSelectionsView.healthcareRole}</p>
    </div>
  );
}
...
function Paragraph() {
  return (
    <div className="absolute h-[20px] left-0 top-[95.99px] w-[573.6px]" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-0 not-italic text-[#bedbff] text-[14px] top-[-0.2px] whitespace-nowrap">{`${scopeDemandSelectionsView.cityTier} · ${scopeDemandSelectionsView.hospitalType} · ${scopeDemandSelectionsView.experienceYears} yrs exp · ${scopeDemandSelectionsView.shift}`}</p>
    </div>
  );
}
...
function Container17() {
  return (
    <div className="h-[48px] relative shrink-0 w-full" data-name="Container">
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[48px] left-0 not-italic text-[48px] text-white top-[-3px] whitespace-nowrap">{`Rs ${formatInr(salaryBreakdownView.monthlyGross)}`}</p>
    </div>
  );
}
...
function Text10() {
  return (
    <div className="h-[20px] relative shrink-0 w-[50.063px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[20px] left-0 not-italic text-[14px] text-white top-[-0.2px] whitespace-nowrap">{`Rs ${formatInr(salaryBreakdownView.monthlyMin)}`}</p>
      </div>
    </div>
  );
}
...
function Text11() {
  return (
    <div className="h-[20px] relative shrink-0 w-[50.025px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[20px] left-0 not-italic text-[14px] text-white top-[-0.2px] whitespace-nowrap">{`Rs ${formatInr(salaryBreakdownView.monthlyMax)}`}</p>
      </div>
    </div>
  );
}
...
function Text13() {
  return (
    <div className="h-[24px] relative shrink-0 w-[54.725px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] left-0 not-italic text-[16px] text-white top-[-2.2px] whitespace-nowrap">{formatInr(salaryBreakdownView.baseMonthly)}</p>
      </div>
    </div>
  );
}
...
function Text15() {
  return (
    <div className="h-[24px] relative shrink-0 w-[57.213px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] left-0 not-italic text-[16px] text-white top-[-2.2px] whitespace-nowrap">{formatInr(salaryBreakdownView.hraAllowances)}</p>
      </div>
    </div>
  );
}
...
function Text17() {
  return (
    <div className="h-[24px] relative shrink-0 w-[69.912px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] left-0 not-italic text-[16px] text-white top-[-2.2px] whitespace-nowrap">{formatInr(salaryBreakdownView.annualGross)}</p>
      </div>
    </div>
  );
}
...
function Text18() {
  return (
    <div className="h-[24px] relative shrink-0 w-[193.75px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[24px] left-0 not-italic text-[#46ecd5] text-[16px] top-[-2.2px] whitespace-nowrap">Estimated take-home / mo</p>
      </div>
    </div>
  );
}
...
function Text19() {
  return (
    <div className="h-[28px] relative shrink-0 w-[67.013px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[28px] left-0 not-italic text-[#46ecd5] text-[18px] top-[-1.4px] whitespace-nowrap">{formatInr(salaryBreakdownView.takeHomeMonthly)}</p>
      </div>
    </div>
  );
}
...
function Button6() {
  return (
    <div className="bg-[#00bba7] h-[56px] relative rounded-[26843500px] shrink-0 w-full" data-name="Button">
      <p className="-translate-x-1/2 absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] left-[273.4px] not-italic text-[16px] text-center text-white top-[13.8px] whitespace-nowrap">Talk to a Career Counsellor</p>
      <Icon5 />
    </div>
  );
}
...
function About4() {
  return (
    <div className="-translate-x-1/2 absolute bg-white content-stretch flex flex-col gap-[70px] items-center left-1/2 px-[34px] py-[60px] top-[2954px] w-[1440px]" data-name="About">
      <Frame49 />
      <Container4 />
    </div>
  );
...
function Heading13() {
  return (
    <div className="h-[48px] relative shrink-0 w-full" data-name="Heading 2">
      <p className="-translate-x-1/2 absolute font-['Inter:Bold',sans-serif] font-bold leading-[48px] left-[81px] not-italic text-[#25a88d] text-[20px] text-center top-[-1px] whitespace-nowrap">iMED Advantage</p>
    </div>
  );
}
...
function Heading14() {
  return (
    <div className="h-[97px] relative shrink-0 w-full" data-name="Heading 3">
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[48px] left-0 not-italic text-[#1f3471] text-[40px] top-[-1px] w-[551px]">How iMED Academy helps you succeed</p>
    </div>
  );
}
...
function Frame51() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      <MdiTick />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[27px] not-italic relative shrink-0 text-[#333] text-[18px] whitespace-nowrap">100% online learning with recorded video modules</p>
    </div>
  );
}
...
function Frame54() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      <MdiTick1 />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[27px] not-italic relative shrink-0 text-[#333] text-[18px] whitespace-nowrap">Industry-relevant curriculum designed by healthcare professionals</p>
    </div>
  );
}
...
function Frame55() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      <MdiTick2 />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[27px] not-italic relative shrink-0 text-[#333] text-[18px] whitespace-nowrap">Live doubt-clearing sessions and mentor support</p>
    </div>
  );
}
...
function Frame56() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      <MdiTick3 />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[27px] not-italic relative shrink-0 text-[#333] text-[18px] whitespace-nowrap">Real-world case studies from Indian hospitals</p>
    </div>
  );
}
...
function Frame57() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      <MdiTick4 />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[27px] not-italic relative shrink-0 text-[#333] text-[18px] w-[566px] whitespace-pre-wrap">{`Flexible schedule  learn at your own pace`}</p>
    </div>
  );
}
...
function Frame58() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      <MdiTick5 />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[27px] not-italic relative shrink-0 text-[#333] text-[18px] w-[566px]">Certificate recognized by iMED partner institutes</p>
    </div>
  );
}
...
function Heading15() {
  return (
    <div className="h-[48px] relative shrink-0 w-full" data-name="Heading 2">
      <p className="-translate-x-1/2 absolute font-['Inter:Bold',sans-serif] font-bold leading-[48px] left-[94.5px] not-italic text-[#25a88d] text-[20px] text-center top-[-1px] whitespace-nowrap">Placement Support</p>
    </div>
  );
}
...
function Frame60() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      <MdiTick6 />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[27px] not-italic relative shrink-0 text-[#333] text-[18px] whitespace-nowrap">Career guidance and job-readiness workshops</p>
    </div>
  );
}
...
function Frame61() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      <MdiTick7 />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[27px] not-italic relative shrink-0 text-[#333] text-[18px] whitespace-nowrap">Resume building for healthcare admin roles</p>
    </div>
  );
}
...
function Frame62() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      <MdiTick8 />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[27px] not-italic relative shrink-0 text-[#333] text-[18px] whitespace-nowrap">Mock interviews and aptitude preparation</p>
    </div>
  );
}
...
function Frame63() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      <MdiTick9 />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[27px] not-italic relative shrink-0 text-[#333] text-[18px] whitespace-nowrap">Job referrals through partner hospitals and clinics</p>
    </div>
  );
}
...
function Frame64() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      <MdiTick10 />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[27px] not-italic relative shrink-0 text-[#333] text-[18px] w-[566px]">LinkedIn profile optimization for healthcare careers</p>
    </div>
  );
}
...
function Frame65() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      <MdiTick11 />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[27px] not-italic relative shrink-0 text-[#333] text-[18px] w-[566px]">Alumni network access for ongoing career support</p>
    </div>
  );
}
...
function Text20() {
  return (
    <div className="absolute h-[20px] left-[-0.2px] top-[15.8px] w-[192.425px]" data-name="Text">
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#0a0a0a] text-[20px] top-[-0.2px] whitespace-nowrap">What is OCHA?</p>
    </div>
  );
}
...
function Text21() {
  return (
    <div className="absolute h-[20px] left-[-0.2px] top-[15.8px] w-[192.425px]" data-name="Text">
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#0a0a0a] text-[20px] top-[-0.2px] whitespace-nowrap">Is this course fully online?</p>
    </div>
  );
}
...
function Text22() {
  return (
    <div className="absolute h-[20px] left-[-0.2px] top-[15.8px] w-[192.425px]" data-name="Text">
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#0a0a0a] text-[20px] top-[-0.2px] whitespace-nowrap">Who should take this course?</p>
    </div>
  );
}
...
function Text23() {
  return (
    <div className="absolute h-[20px] left-[-0.2px] top-[15.8px] w-[192.425px]" data-name="Text">
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#0a0a0a] text-[20px] top-[-0.2px] whitespace-nowrap">Will I get a certificate?</p>
    </div>
  );
}
...
function Text24() {
  return (
    <div className="absolute h-[20px] left-[-0.2px] top-[15.8px] w-[192.425px]" data-name="Text">
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#0a0a0a] text-[20px] top-[-0.2px] whitespace-nowrap">Can I work while studying?</p>
    </div>
  );
}
...
function Text25() {
  return (
    <div className="absolute h-[20px] left-[-0.2px] top-[15.8px] w-[192.425px]" data-name="Text">
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#0a0a0a] text-[20px] top-[-0.2px] whitespace-nowrap">What is the duration of the course?</p>
    </div>
  );
}
...
function Text26() {
  return (
    <div className="absolute h-[20px] left-[-0.2px] top-[15.8px] w-[192.425px]" data-name="Text">
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#0a0a0a] text-[20px] top-[-0.2px] whitespace-nowrap">Are there any prerequisites to join this course?</p>
    </div>
  );
}
...
function About7Dynamic({ openIndex, onToggle }: { openIndex: number | null; onToggle: (index: number) => void }) {
  return (
    <div className="-translate-x-1/2 absolute bg-white content-stretch flex flex-col gap-[39px] items-center left-1/2 px-[32px] py-[60px] top-[6375px] w-[1440px]" data-name="About">
      <Container31 />
      <div className="bg-white h-auto relative rounded-[14px] shrink-0 w-[848px]">
        <div className="content-stretch flex flex-col items-start overflow-clip p-[0.8px] relative rounded-[inherit] size-full">
          {ochaFaqItems.map((item, index) => {
            const isOpen = openIndex === index;
            return (
              <div className="w-full" key={item.question}>
                <button className="h-[75px] relative w-full text-left px-[24px]" onClick={() => onToggle(index)} type="button">
                  <div aria-hidden="true" className="absolute border-[rgba(0,0,0,0.1)] border-b-[0.8px] border-solid inset-0 pointer-events-none" />
                  <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-[24px] not-italic text-[#0a0a0a] text-[20px] top-[27px] whitespace-nowrap">{item.question}</p>
                  <span className="absolute font-['Inter:Bold',sans-serif] leading-none right-[24px] text-[#25A88D] text-[28px] top-[20px]">{isOpen ? "−" : "+"}</span>
                </button>
                {isOpen ? <p className="px-[24px] pb-[18px] pt-[2px] text-[#4a5565] text-[16px] leading-[26px]">{item.answer}</p> : null}
              </div>
            );
          })}
        </div>
...
function Heading19() {
  return (
    <div className="content-stretch flex h-[36px] items-start relative shrink-0 w-[905px]" data-name="Heading 3">
      <p className="flex-[1_0_0] font-['Inter:Bold',sans-serif] font-bold leading-[36px] min-w-px not-italic relative text-[30px] text-center text-white">Ready to start your OCHA journey?</p>
    </div>
  );
}
...
function Paragraph5() {
  return (
    <div className="h-[35px] relative shrink-0 w-[765px]" data-name="Paragraph">
      <p className="-translate-x-1/2 absolute font-['Inter:Regular',sans-serif] font-normal h-[58px] leading-[28px] left-[382px] not-italic text-[#dbeafe] text-[18px] text-center top-[0.5px] w-[560px]">Limited seats for the 2026 batch. Apply online in under 5 minutes.</p>
    </div>
  );
}
...
function Frame131() {
  return (
    <div className="content-stretch flex flex-col gap-[5px] h-[40px] items-start not-italic py-[6px] relative shrink-0 text-white w-[185px]">
      ...
      <div className="h-[37.242px] overflow-clip relative shrink-0 w-[125.692px]" data-name="Badge">
        ...
        <div className="absolute inset-[18.68%_83.04%_18.65%_7.38%]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12.0425 23.3415">
            <path d={svgPaths.p2192fa80} fill="url(#paint0_linear_1_237)" id="Vector" />
            <defs>
              <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_1_237" x1="11.0184" x2="-4.60472" y1="1.15451" y2="16.7776">
        ...
        <div className="absolute inset-[39.3%_75.52%_39.3%_16.96%]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 9.4502 7.96983">
            <path d={svgPaths.p14fc2800} fill="url(#paint0_linear_1_173)" id="Vector" />
            <defs>
              <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_1_173" x1="10.1764" x2="-12.3458" y1="3.98491" y2="3.98491">
        ...
        <div className="absolute bottom-[17.83%] left-[7.73%] right-[79.91%] top-1/2" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15.53 11.9826">
            <path d={svgPaths.p2b5f2100} fill="url(#paint0_linear_1_167)" id="Vector" />
            <defs>
              <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_1_167" x1="13.3979" x2="-7.79293" y1="2.14143" y2="23.3229">
        ...
        <div className="absolute bottom-1/2 left-[7.73%] right-[79.91%] top-[17.83%]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15.53 11.9805">
            <path d={svgPaths.p6c4e600} fill="url(#paint0_linear_1_161)" id="Vector" />
            <defs>
              <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_1_161" x1="-2.92351" x2="6.536" y1="-6.47302" y2="2.98649">
  ...
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0">
      {footerContactItems.map((item) => (
        <div className="content-stretch flex gap-[13px] items-start relative shrink-0" key={item.label}>
          {item.icon === "email" ? <IcRoundEmail /> : <SolarPhoneBold />}
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[18px] text-white whitespace-nowrap">{item.label}</p>
        </div>
      ))}
    </div>
  );
  ...
  return (
    <div className="col-1 content-stretch flex gap-[12px] items-center ml-0 mt-0 relative row-1">
      {socialItems.map(({ label, href, Icon }) => (
        <a aria-label={label} className="inline-flex" href={href} key={label} rel="noopener noreferrer" target="_blank">
          <Icon />
        </a>
      ))}
    </div>
  ...
  return (
    <div className="content-stretch flex gap-[30px] items-center relative shrink-0">
      {footerLegalLinks.map((item) => (
        <button className="cursor-pointer relative shrink-0 transition-colors duration-200 hover:text-[#8ee2d2]" key={item.label} onClick={() => handleFooterNavigation(item)} type="button">
          {item.label}
        </button>
      ))}
    </div>
...
export default function Ocha() {
  const designWidth = 1440;
  const pageRef = useRef<HTMLDivElement>(null);
  const [pageScale, setPageScale] = useState(1);
  const [scaledHeight, setScaledHeight] = useState<number | null>(null);
  const [openFaqIndex, setOpenFaqIndex] = useState<number | null>(null);
  const [scopeDemandSelections, setScopeDemandSelections] = useState<ScopeDemandSelections>(defaultSelections);
  const salaryBreakdown = computeSalaryBreakdown(scopeDemandSelections);

  scopeDemandSelectionsView = scopeDemandSelections;
  salaryBreakdownView = salaryBreakdown;
  updateScopeDemandSelection = <K extends keyof ScopeDemandSelections>(key: K, value: ScopeDemandSelections[K]) => {
    setScopeDemandSelections((previous) => ({ ...previous, [key]: value }));
  };
    ...
    >
      ...
      >
        <div className="bg-white relative size-full">
          ...
          <About5 />
          <About6 />
          <About7Dynamic onToggle={(index) => setOpenFaqIndex((prev) => (prev === index ? null : index))} openIndex={openFaqIndex} />
          <Container41 />
          <Frame15 />
        </div>
      </div>
