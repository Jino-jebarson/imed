    ...
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid place-items-start relative shrink-0">
      <div className="col-1 h-[38px] ml-0 mt-0 relative row-1 w-[203px]" data-name="image 1712">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" loading="eager" fetchPriority="high" decoding="async" className="absolute inset-0 h-full w-full max-w-none object-contain" src={imgImage1712} />
        </div>
      </div>
    </div>
  );
...
function Frame52() {
  return (
    <button data-nav-target="home" className="content-stretch flex gap-[10px] items-center leading-[0] relative shrink-0 w-[203px] text-left [&>p]:hidden transition-transform duration-200 hover:scale-[1.02]">
      <Group10 />
