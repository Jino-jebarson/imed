...
import svgPaths from "./svg-udf6enc0k4";
import imgImage1712 from "./imed-academy-logo.png";
import imgImage1722 from "./mlt-hero-background.webp";
import imgImage1745 from "./mlt-program-overview.webp";
import imgImage1709 from "./mlt-training-photo.webp";
import imgContainer from "./decorative-container.png";
import imgImage1723 from "./mlt-career-path.webp";
import imgImage1724 from "./mlt-student-training.webp";
...
function Frame132() {
  return (
    <button data-nav-target="imed-online" className="group block h-[24px] relative shrink-0 w-[127px] transition-colors duration-200 hover:text-[#1f3471]">
      <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Inter:Medium',sans-serif] font-medium leading-[24px] left-[63.5px] not-italic text-[#333] text-[16px] text-center top-0 whitespace-nowrap transition-colors duration-200 group-hover:text-[#1f3471]">Online Programs</p>
      <span aria-hidden="true" className="absolute pointer-events-none left-1/2 -bottom-[3px] h-[2px] w-0 -translate-x-1/2 rounded-full bg-[#25a88d] transition-all duration-300 group-hover:w-[82%]" />
    </button>
  );
}
...
function Frame133() {
  return (
    <button data-nav-target="trusted-partners" className="group block h-[24px] relative shrink-0 w-[98px] transition-colors duration-200 hover:text-[#1f3471]">
      <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Inter:Medium',sans-serif] font-medium leading-[24px] left-[49px] not-italic text-[#333] text-[16px] text-center top-0 whitespace-nowrap transition-colors duration-200 group-hover:text-[#1f3471]">Our Partners</p>
...
function Frame30() {
  return (
    <div className="content-stretch flex flex-col font-['Inter:Bold',sans-serif] font-bold items-start relative shrink-0 text-[50px]">
      ...
      <p className="h-[139px] leading-[70px] relative shrink-0 text-[#25a88d] w-[587px]">Medical Laboratory Technician</p>
    </div>
  );
}
...
function Frame20() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[20px] items-start not-italic relative shrink-0 w-full">
      <Frame30 />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[0] relative shrink-0 text-[20px] text-white w-[723px]">
        <span className="leading-[32.5px]">{`An industry-focused program in collaboration with `}</span>
        <span className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[32.5px] text-[#2dd4bf]">Lingaya’s Vidyapeeth</span>
        <span className="leading-[32.5px]">, designed to deliver academic excellence, practical laboratory training, and real-world clinical exposure to shape your future in healthcare.</span>
      </p>
    </div>
  );
}
...
function Frame21() {
  return (
    <div className="-translate-y-1/2 absolute content-stretch flex flex-col gap-[20px] h-[408px] items-start left-[67px] top-[calc(50%+46px)] w-[732px]">
      <Frame20 />
      <Frame19 />
    </div>
  );
...
function Frame15() {
  return (
    <div id="imed-online" data-nav="imed-online" className="absolute bg-[#1f3471] h-[666px] left-0 overflow-clip top-[66px] w-[1440px]">
      <div className="-translate-x-1/2 -translate-y-1/2 absolute h-[665px] left-[calc(50%+221px)] opacity-47 top-[calc(50%+3.5px)] w-[998px]" data-name="image 1722">
      ...
      <div className="absolute bg-gradient-to-r from-[#1f3471] from-[12.981%] h-[665px] left-[422px] to-[rgba(31,52,113,0)] top-px w-[449px]" />
      <Frame21 />
    </div>
  );
}
...
function Heading2() {
  return (
    <div className="h-[48px] relative shrink-0 w-full" data-name="Heading 3">
      <p className="-translate-x-1/2 [word-break:break-word] absolute font-['Inter:Bold',sans-serif] font-bold leading-[48px] left-1/2 not-italic text-[#1f3471] text-[40px] text-center top-[-1px] whitespace-nowrap">What is Medical Laboratory Technician?</p>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full">
      <div className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[0] not-italic relative shrink-0 text-[#4a5565] text-[20px] text-justify w-full whitespace-pre-wrap">
        <p className="leading-[32.5px] mb-0">{`The Medical Laboratory Technician (MLT) program trains students to perform clinical laboratory tests that help doctors diagnose, monitor, and treat diseases. It is one of India's most in-demand allied healthcare careers across hospitals, diagnostic chains, and research labs.`}</p>
        <p className="leading-[32.5px] mb-0">​</p>
        <p className="leading-[32.5px]">An MLT collects samples, runs biochemistry, hematology, microbiology, pathology, and serology tests, operates laboratory analyzers, maintains quality control, and prepares accurate reports for clinicians. MLTs do not diagnose patients; they provide the test data doctors rely on to make decisions.</p>
      </div>
    </div>
  );
}
...
function Frame64() {
  return (
    <div className="-translate-y-1/2 absolute content-stretch flex gap-[15px] items-center left-[15px] top-[calc(50%+0.5px)]">
      <Frame63 />
      <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[48px] not-italic relative shrink-0 text-[18px] text-black text-center whitespace-nowrap">{`Human anatomy & physiology for lab work`}</p>
    </div>
  );
}
...
function Frame65() {
  return (
    <div className="-translate-y-1/2 absolute content-stretch flex gap-[15px] items-center left-[15px] top-[calc(50%+0.5px)]">
      <Frame66 />
      <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[48px] not-italic relative shrink-0 text-[18px] text-black text-center whitespace-nowrap">{`Hematology, blood banking & transfusion`}</p>
    </div>
  );
}
...
function Frame67() {
  return (
    <div className="-translate-y-1/2 absolute content-stretch flex gap-[15px] items-center left-[15px] top-[calc(50%+0.5px)]">
      <Frame68 />
      <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[48px] not-italic relative shrink-0 text-[18px] text-black text-center whitespace-nowrap">{`Histopathology & cytology basics`}</p>
    </div>
  );
}
...
function Frame69() {
  return (
    <div className="-translate-y-1/2 absolute content-stretch flex gap-[15px] items-center left-[15px] top-[calc(50%+0.5px)]">
      <Frame70 />
      <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[48px] not-italic relative shrink-0 text-[18px] text-black text-center whitespace-nowrap">Lab quality control and biosafety</p>
    </div>
  );
}
...
function Frame71() {
  return (
    <div className="-translate-y-1/2 absolute content-stretch flex gap-[15px] items-center left-[15px] top-[calc(50%+0.5px)]">
      <Frame77 />
      <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[48px] not-italic relative shrink-0 text-[18px] text-black text-center whitespace-nowrap">Clinical biochemistry and analyzers</p>
    </div>
  );
}
...
function Frame79() {
  return (
    <div className="-translate-y-1/2 absolute content-stretch flex gap-[15px] items-center left-[15px] top-[calc(50%+0.5px)]">
      <Frame83 />
      <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[48px] not-italic relative shrink-0 text-[18px] text-black text-center whitespace-nowrap">{`Clinical microbiology & culture techniques`}</p>
    </div>
  );
}
...
function Frame85() {
  return (
    <div className="-translate-y-1/2 absolute content-stretch flex gap-[15px] items-center left-[15px] top-[calc(50%+0.5px)]">
      <Frame86 />
      <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[48px] not-italic relative shrink-0 text-[18px] text-black text-center whitespace-nowrap">{`Sample collection, handling & phlebotomy`}</p>
    </div>
  );
}
...
function Frame88() {
  return (
    <div className="-translate-y-1/2 absolute content-stretch flex gap-[15px] items-center left-[15px] top-[calc(50%+0.5px)]">
      <Frame89 />
      <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[48px] not-italic relative shrink-0 text-[18px] text-black text-center whitespace-nowrap">{`Hospital information & lab reporting systems`}</p>
    </div>
  );
}
...
function Frame111() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      ...
      <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[23px] not-italic relative shrink-0 text-[18px] text-center text-white whitespace-nowrap">{`12th pass with Science (Biology preferred) `}</p>
    </div>
  );
}
...
function Frame112() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0 w-full">
      ...
      <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[23px] not-italic relative shrink-0 text-[18px] text-center text-white whitespace-nowrap">Interest in laboratory science and diagnostics</p>
    </div>
  );
}
...
function Frame113() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      ...
      <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[23px] not-italic relative shrink-0 text-[18px] text-center text-white whitespace-nowrap">Attention to detail and accuracy</p>
    </div>
  );
}
...
function Frame114() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      ...
      <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[23px] not-italic relative shrink-0 text-[18px] text-center text-white whitespace-nowrap">Basic English communication skills</p>
    </div>
  );
}
...
function Frame115() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      ...
      <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[23px] not-italic relative shrink-0 text-[18px] text-center text-white w-[442px]">Personal interview with iMED admissions counselor</p>
    </div>
  );
}
...
function Frame36() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[764px]">
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal h-[194px] leading-[32.5px] not-italic relative shrink-0 text-[#4a5565] text-[20px] text-justify w-full">{`India's diagnostic industry is expanding rapidly through hospital chains, standalone diagnostic labs (Dr Lal, Metropolis, Thyrocare, SRL), home-sample collection startups, and research labs. Trained MLTs are in continuous demand across pathology, biochemistry, microbiology, and blood bank departments.`}</p>
    </div>
  );
}
...
function Frame117() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[10px] items-start not-italic relative shrink-0 text-white w-[198px]">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[39px] relative shrink-0 text-[18px] w-full">Entry-Level MLT</p>
...
function Frame119() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[10px] items-start not-italic relative shrink-0 text-white w-[198px]">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[39px] relative shrink-0 text-[18px] w-[261px]">Senior Lab Technician</p>
...
function Frame122() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[10px] items-start not-italic relative shrink-0 text-white w-[198px]">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[39px] relative shrink-0 text-[18px] w-[263px]">Pathology Technician</p>
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] min-w-full relative shrink-0 text-[25px] w-[min-content]">₹3.5 – 4.5 LPA</p>
    </div>
  );
}
...
function Frame124() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[10px] items-start not-italic relative shrink-0 text-white w-[198px]">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[39px] relative shrink-0 text-[18px] w-[234px]">Lab Supervisor / In-Charge</p>
...
function Frame26() {
  return (
    <div className="bg-[#824747] h-[517px] overflow-clip relative rounded-[15px] shrink-0 w-[499px]">
      <div className="-translate-x-1/2 absolute h-[1085px] left-[calc(50%-0.5px)] top-[-241px] w-[724px]" data-name="image 1709">
...
function About4() {
  return <ScopeSalarySection defaultRole="Medical Laboratory Technician" topClassName="top-[2954px]" />;
}
...
function Frame45() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      <MdiTick />
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[27px] not-italic relative shrink-0 text-[#333] text-[18px] w-[504px]">Hands-on training in fully-equipped pathology and biochem labs</p>
    </div>
  );
}
...
function Frame48() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      <MdiTick1 />
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[27px] not-italic relative shrink-0 text-[#333] text-[18px] w-[504px]">Faculty from leading diagnostic chains and hospitals</p>
    </div>
  );
}
...
function Frame49() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      <MdiTick2 />
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[27px] not-italic relative shrink-0 text-[#333] text-[18px] w-[504px]">Live practice on analyzers, microscopes, and centrifuges</p>
    </div>
  );
}
...
function Frame50() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      <MdiTick3 />
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[27px] not-italic relative shrink-0 text-[#333] text-[18px] w-[504px]">Training on sample collection, phlebotomy, and biosafety</p>
    </div>
  );
}
...
function Frame51() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      <MdiTick4 />
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[27px] not-italic relative shrink-0 text-[#333] text-[18px] w-[566px]">Exposure to lab quality control (NABL awareness)</p>
    </div>
  );
}
...
function Frame52() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      <MdiTick5 />
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[27px] not-italic relative shrink-0 text-[#333] text-[18px] w-[566px]">Career mentoring for diagnostic and hospital lab roles</p>
    </div>
  );
}
...
function Frame54() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      <MdiTick6 />
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[27px] not-italic relative shrink-0 text-[#333] text-[18px] w-[504px]">Placement assistance with hospitals and diagnostic chains</p>
    </div>
  );
}
...
function Frame55() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      <MdiTick7 />
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[27px] not-italic relative shrink-0 text-[#333] text-[18px] w-[504px]">Resume building for lab technician roles</p>
    </div>
  );
}
...
function Frame56() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      <MdiTick8 />
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[27px] not-italic relative shrink-0 text-[#333] text-[18px] w-[504px]">Mock interviews and practical skill tests</p>
    </div>
  );
}
...
function Frame57() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      <MdiTick9 />
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[27px] not-italic relative shrink-0 text-[#333] text-[18px] w-[504px]">Internship guidance in pathology and biochem labs</p>
    </div>
  );
}
...
function Frame58() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      <MdiTick10 />
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[27px] not-italic relative shrink-0 text-[#333] text-[18px] w-[566px]">Hiring tie-ups with home-sample collection companies</p>
    </div>
  );
}
...
function Frame59() {
  return (
    <div className="content-stretch flex gap-[15px] items-center relative shrink-0">
      <MdiTick11 />
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[27px] not-italic relative shrink-0 text-[#333] text-[18px] w-[566px]">Career counseling for growth into lab supervisor roles</p>
    </div>
  );
}
...
function Text20() {
  return (
    <div className="absolute h-[20px] left-[-0.2px] top-[15.8px] w-[192.425px]" data-name="Text">
      <p className="[word-break:break-word] absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#0a0a0a] text-[20px] top-[-0.2px] whitespace-nowrap">What is the MLT course?</p>
    </div>
  );
}
...
function Text21() {
  return (
    <div className="absolute h-[20px] left-[-0.2px] top-[15.8px] w-[192.425px]" data-name="Text">
      <p className="[word-break:break-word] absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#0a0a0a] text-[20px] top-[-0.2px] w-[560px]">Will I become a doctor after MLT?</p>
    </div>
  );
}
...
function Text22() {
  return (
    <div className="absolute h-[20px] left-[-0.2px] top-[15.8px] w-[192.425px]" data-name="Text">
      <p className="[word-break:break-word] absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#0a0a0a] text-[20px] top-[-0.2px] w-[560px]">Where can I work after MLT?</p>
    </div>
  );
}
...
function Text23() {
  return (
    <div className="absolute h-[20px] left-[-0.2px] top-[15.8px] w-[192.425px]" data-name="Text">
      <p className="[word-break:break-word] absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#0a0a0a] text-[20px] top-[-0.2px] w-[560px]">Is practical training included?</p>
    </div>
  );
}
...
function Text24() {
  return (
    <div className="absolute h-[20px] left-[-0.2px] top-[15.8px] w-[192.425px]" data-name="Text">
      <p className="[word-break:break-word] absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#0a0a0a] text-[20px] top-[-0.2px] w-[560px]">Do I need a science background?</p>
    </div>
  );
}
...
function Text25() {
  return (
    <div className="absolute h-[20px] left-[-0.2px] top-[15.8px] w-[192.425px]" data-name="Text">
      <p className="[word-break:break-word] absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#0a0a0a] text-[20px] top-[-0.2px] w-[560px]">What laboratory equipment will I learn to use?</p>
    </div>
  );
}
...
function Text26() {
  return (
    <div className="absolute h-[20px] left-[-0.2px] top-[15.8px] w-[192.425px]" data-name="Text">
      <p className="[word-break:break-word] absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#0a0a0a] text-[20px] top-[-0.2px] w-[560px]">. How does this course help me become job-ready?</p>
    </div>
  );
}
...
const mltFaqItems = [
  {
    question: "What is the MLT course?",
    answer:
      "The Medical Laboratory Technician course trains you to support diagnostic labs through sample collection, testing support, equipment handling, reporting workflows, and lab safety practices.",
  },
  {
    question: "Will I become a doctor after MLT?",
    answer:
      "No. MLT prepares you for laboratory and diagnostic support roles, not doctor or nurse roles. You work with healthcare teams by helping process and support accurate diagnostic testing.",
  },
  {
    question: "Where can I work after MLT?",
    answer:
      "You can work in hospitals, diagnostic labs, pathology centers, collection centers, blood banks, and healthcare facilities that need trained laboratory support staff.",
  },
  {
    question: "Is practical training included?",
    answer:
      "Yes. The program focuses on practical lab exposure, standard operating procedures, sample handling, infection control, and hands-on familiarity with common laboratory workflows.",
  },
  {
    question: "Do I need a science background?",
    answer:
      "A science background is helpful, but our counsellors can guide you based on your education profile and the eligibility requirements for the batch you want to join.",
  },
  {
    question: "What laboratory equipment will I learn to use?",
    answer:
      "You will learn the basics of equipment and processes used in diagnostic settings, including sample collection tools, microscopes, centrifuge workflows, analyzers, and lab documentation practices.",
  },
  {
    question: "How does this course help me become job-ready?",
    answer:
      "The course builds job-ready habits through practical training, lab etiquette, safety protocols, reporting discipline, interview preparation, and placement-focused guidance.",
  },
];
...
function Heading19() {
  return (
    <div className="content-stretch flex h-[36px] items-start relative shrink-0 w-[905px]" data-name="Heading 3">
      <p className="[word-break:break-word] flex-[1_0_0] font-['Inter:Bold',sans-serif] font-bold leading-[36px] min-w-px not-italic relative text-[30px] text-center text-white">Ready to start your MLT journey?</p>
    </div>
  );
}
      ...
      <div className="h-[37.242px] overflow-clip relative shrink-0 w-[125.692px]" data-name="Badge">
        ...
        <div className="absolute inset-[18.68%_83.04%_18.65%_7.38%]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12.0425 23.3415">
            <path d={svgPaths.p2192fa80} fill="url(#paint0_linear_1_1178)" id="Vector" />
            <defs>
              <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_1_1178" x1="11.0184" x2="-4.60472" y1="1.15451" y2="16.7776">
        ...
        <div className="absolute inset-[39.3%_75.52%_39.3%_16.96%]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 9.4502 7.96983">
            <path d={svgPaths.p14fc2800} fill="url(#paint0_linear_1_1099)" id="Vector" />
            <defs>
              <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_1_1099" x1="10.1764" x2="-12.3458" y1="3.98491" y2="3.98491">
        ...
        <div className="absolute bottom-[17.83%] left-[7.73%] right-[79.91%] top-1/2" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15.53 11.9826">
            <path d={svgPaths.p2b5f2100} fill="url(#paint0_linear_1_1093)" id="Vector" />
            <defs>
              <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_1_1093" x1="13.3979" x2="-7.79293" y1="2.14143" y2="23.3229">
        ...
        <div className="absolute bottom-1/2 left-[7.73%] right-[79.91%] top-[17.83%]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15.53 11.9805">
            <path d={svgPaths.p6c4e600} fill="url(#paint0_linear_1_1087)" id="Vector" />
            <defs>
              <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_1_1087" x1="-2.92351" x2="6.536" y1="-6.47302" y2="2.98649">
