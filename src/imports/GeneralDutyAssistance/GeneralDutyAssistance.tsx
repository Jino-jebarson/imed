...
function Frame17() {
  return (
    <button
      ...
      className="group block h-[24px] relative shrink-0 w-[65px] transition-all duration-200 hover:-translate-y-0.5 hover:text-[#1f3471]"
    >
...
function Frame20() {
  return (
    <button
      ...
      className="group block h-[24px] relative shrink-0 w-[109px] transition-all duration-200 hover:-translate-y-0.5 hover:text-[#1f3471]"
    >
...
function Frame21() {
  return (
    <button
      ...
      className="group block h-[24px] relative shrink-0 w-[95px] transition-all duration-200 hover:-translate-y-0.5 hover:text-[#1f3471]"
    >
